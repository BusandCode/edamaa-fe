    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Join a Class</h1>
              <p className="text-sm text-gray-600 mt-0.5">Browse classes or enter a class code</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 pb-24 md:pb-8">
        ...
        <div className="bg-white rounded-xl border-2 border-gray-200 p-4 sm:p-6 mb-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Have a Class Code?</h2>
          <div className="flex flex-col sm:flex-row gap-3">
            <input
              ...
              className="flex-1 px-4 py-2.5 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#3D08BA] focus:border-[#3D08BA] font-mono uppercase"
              maxLength={10}
            />
            <button
              onClick={handleJoinWithCode}
              disabled={!joinCode.trim() || isLoading}
              className="px-6 py-2.5 bg-[#3D08BA] text-white rounded-lg hover:bg-[#2D0690] disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors font-medium whitespace-nowrap"
            >
          ...
          {error && (
            <div className="mt-4 p-3 bg-red-50 border-2 border-red-500 rounded-lg flex items-start gap-2">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#3D08BA] focus:border-[#3D08BA]"
              />
            </div>
      ...
      {selectedClass && !joinSuccess && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 overflow-y-auto">
          ...
          />
          <div className="relative bg-white rounded-xl border-2 border-gray-200 max-w-2xl w-full my-8">
            {/* Class Header */}
            <div className="bg-[#3D08BA] p-6 text-white rounded-t-xl">
              <div className="flex items-start justify-between gap-4 mb-3">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-sm font-bold bg-white/20 px-2.5 py-1 rounded">
                      {selectedClass.code}
                    </span>
            ...
            <div className="p-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-6 border-t-2 border-gray-200">
                <button
                  ...
                  disabled={isLoading}
                  className="flex-1 px-6 py-3 bg-[#3D08BA] text-white rounded-lg hover:bg-[#2D0690] disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors font-semibold"
                >
