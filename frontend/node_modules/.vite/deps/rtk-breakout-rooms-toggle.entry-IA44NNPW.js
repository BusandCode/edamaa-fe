...
// node_modules/@cloudflare/realtimekit-ui/dist/esm/rtk-breakout-rooms-toggle.entry.js
var rtkBreakoutRoomsToggleCss = ":host{line-height:initial;font-family:var(--rtk-font-family, sans-serif);font-feature-settings:normal;font-variation-settings:normal}p{margin:var(--rtk-space-0, 0px);padding:var(--rtk-space-0, 0px)}:host{display:block}";
var RtkBreakoutRoomsToggleStyle0 = rtkBreakoutRoomsToggleCss;
...
var RtkBreakoutRoomsToggle = class {
  constructor(hostRef) {
...
export {
  RtkBreakoutRoomsToggle as rtk_breakout_rooms_toggle
};
//# sourceMappingURL=rtk-breakout-rooms-toggle.entry-IA44NNPW.js.map
