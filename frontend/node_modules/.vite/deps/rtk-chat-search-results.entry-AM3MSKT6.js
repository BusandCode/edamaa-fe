...
var RtkChatSearchResults = class {
  constructor(hostRef) {
    ...
    this.nodeRenderer = (messages) => {
      return messages.map((message) => h("rtk-chat-message", { key: message.id, message, disableControls: true }));
    };
  }
  render() {
...
export {
  RtkChatSearchResults as rtk_chat_search_results
};
//# sourceMappingURL=rtk-chat-search-results.entry-AM3MSKT6.js.map
