...
// node_modules/@cloudflare/realtimekit-ui/dist/esm/rtk-stage-toggle.entry.js
var canJoinStage = (meeting) => {
  var _a, _b;
...
var canRequestToJoinStage = (meeting) => {
  var _a, _b;
  return ((_a = meeting === null || meeting === void 0 ? void 0 : meeting.self) === null || _a === void 0 ? void 0 : _a.permissions.stageEnabled) && ((_b = meeting === null || meeting === void 0 ? void 0 : meeting.self) === null || _b === void 0 ? void 0 : _b.permissions.stageAccess) !== "NOT_ALLOWED";
};
var rtkStageToggleCss = ":host{line-height:initial;font-family:var(--rtk-font-family, sans-serif);font-feature-settings:normal;font-variation-settings:normal}p{margin:var(--rtk-space-0, 0px);padding:var(--rtk-space-0, 0px)}:host{display:block}:host([data-hidden]){display:none}";
var RtkStageToggleStyle0 = rtkStageToggleCss;
...
export {
  RtkStageToggle as rtk_stage_toggle
};
//# sourceMappingURL=rtk-stage-toggle.entry-K2NXG2QM.js.map
