...
var MASS_ACTIONS_DEBOUNCE_TIMER = 50;
var RtkGrid = class {
  constructor(hostRef) {
  ...
  meetingChanged(meeting, oldMeeting) {
    ...
    if (meeting != null) {
      ...
      this.pipSupported = ((_a = this.meeting.participants.pip) === null || _a === void 0 ? void 0 : _a.isSupported()) && ((_b = meeting.self.config) === null || _b === void 0 ? void 0 : _b.pipMode);
      ...
      this.screenShareParticipants = participants.joined.toArray().filter((participant) => participant.screenShareEnabled);
  ...
  updateActiveParticipants() {
    ...
    this.hideSelf = this.hidden || stage.status !== "ON_STAGE" || ((_a = self.permissions) === null || _a === void 0 ? void 0 : _a.isRecorder) || self.permissions.hiddenParticipant;
    this.participants = this.filterParticipants([
      ...participants.active.toArray().filter((p) => p.id !== self.id),
      ...participants.viewMode === "ACTIVE_GRID" && !self.isPinned && !this.hideSelf ? [self] : []
    ]);
    this.pinnedParticipants = [
  ...
  render() {
    ...
    return h(Host, null, h(Render, { element: "rtk-grid", defaults, childProps: {
...
//# sourceMappingURL=rtk-grid.entry-ZCIMXYCT.js.map
