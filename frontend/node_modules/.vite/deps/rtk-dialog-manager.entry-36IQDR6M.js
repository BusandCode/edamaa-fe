...
// node_modules/@cloudflare/realtimekit-ui/dist/esm/rtk-dialog-manager.entry.js
var rtkDialogManagerCss = ":host{line-height:initial;font-family:var(--rtk-font-family, sans-serif);font-feature-settings:normal;font-variation-settings:normal}p{margin:var(--rtk-space-0, 0px);padding:var(--rtk-space-0, 0px)}:host{display:block}";
var RtkDialogManagerStyle0 = rtkDialogManagerCss;
...
var RtkDialogManager = class {
  ...
  render() {
    ...
    if ((states === null || states === void 0 ? void 0 : states.image) != null) {
      ...
      return h(Host, null, h("rtk-dialog", { open: true, onRtkDialogClose: onImageClose, hideCloseButton: true, iconPack: this.iconPack, t: this.t }, h(Render, { element: "rtk-image-viewer", defaults, props: { image, onClose: onImageClose } })));
    } else if ((states === null || states === void 0 ? void 0 : states.activeSettings) === true) {
      return h(Host, null, h("rtk-dialog", { open: true, onRtkDialogClose: () => this.updateStoreState("activeSettings", false), iconPack: this.iconPack, t: this.t }, h(Render, { element: "rtk-settings", defaults })));
...
//# sourceMappingURL=rtk-dialog-manager.entry-36IQDR6M.js.map
