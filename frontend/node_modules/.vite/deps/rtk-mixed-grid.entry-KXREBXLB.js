...
var RtkMixedGrid = class {
  ...
  meetingChanged(meeting) {
    var _a, _b, _c, _d;
    if (meeting != null) {
      if (((_a = meeting.meta) === null || _a === void 0 ? void 0 : _a.selfActiveTab) != void 0) {
  ...
  render() {
    ...
    return h(Host, null, h("main", { id: "main-view", part: "main-view" }, ((_a = this.getTabs()) === null || _a === void 0 ? void 0 : _a.length) > 1 && h("rtk-tab-bar", Object.assign({ activeTab: this.activeTab, tabs: this.getTabs(), onTabChange: (e) => this.setActiveTab(e.detail) }, defaults)), h("div", { id: "tabs", key: "tabs" }, this.screenShareParticipants.map((participant) => {
      var _a2, _b2;
      return h(Render, { element: "rtk-screenshare-view", defaults, props: {
        participant,
        key: participant.id,
        style: {
          display: ((_a2 = this.activeTab) === null || _a2 === void 0 ? void 0 : _a2.type) === "screenshare" && ((_b2 = this.activeTab) === null || _b2 === void 0 ? void 0 : _b2.participant.id) === participant.id ? "flex" : "none"
        }
      }, childProps: { participant, isScreenShare: true }, deepProps: true });
    }), this.plugins.map((plugin) => {
      var _a2, _b2;
      return h("rtk-plugin-main", Object.assign({}, defaults, { plugin, key: plugin.id, style: {
        display: ((_a2 = this.activeTab) === null || _a2 === void 0 ? void 0 : _a2.type) === "plugin" && ((_b2 = this.activeTab) === null || _b2 === void 0 ? void 0 : _b2.plugin.id) === plugin.id ? "flex" : "none"
      } }));
    }))), h(Render, { element: "rtk-mixed-grid", defaults, childProps: {
...
export {
  RtkMixedGrid as rtk_mixed_grid
};
//# sourceMappingURL=rtk-mixed-grid.entry-KXREBXLB.js.map
