...
var RtkSetupScreen = class {
      ...
      if (((_a = this.displayName) === null || _a === void 0 ? void 0 : _a.trim()) !== "" && !this.isJoining) {
        if (this.connectionState !== "connected") {
          if (this.connectionState) {
            this.joinError = this.connectionState === "failed" ? this.t("network.lost_extended") : this.t("network.lost");
          }
          return;
        }
        this.isJoining = true;
  ...
  render() {
    ...
    const errorText = this.joinError ? this.joinError : this.connectionState === "failed" ? this.t("network.lost_extended") : this.t("network.lost");
...
export {
  RtkSetupScreen as rtk_setup_screen
};
//# sourceMappingURL=rtk-setup-screen.entry-PGJOBPDT.js.map
