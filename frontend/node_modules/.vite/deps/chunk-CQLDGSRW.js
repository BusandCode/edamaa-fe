...
// node_modules/@cloudflare/realtimekit-ui/dist/esm/config-59ee5579.js
var extendConfig = (config, baseConfig = createDefaultConfig()) => {
...
var generateConfig = (oldConfig, meeting, toExtend = {}, options = { grid_pagination: true, settings_toggle: true }) => {
  ...
  let config = {
    ...
    root: Object.assign(Object.assign(Object.assign({ "rtk-meeting": {
      ...
      add: [["rtk-sidebar", { view: "full-screen" }]]
    }, "rtk-meeting[meeting=ended]": ["rtk-ended-screen"] }, headerChildren), controlBarChildren), {
      "rtk-stage": {
        states: ["activeSidebar"],
...
//# sourceMappingURL=chunk-CQLDGSRW.js.map
