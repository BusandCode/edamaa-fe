...
var MIN_ROOMS = 1;
var RtkBreakoutRoomsManager = class {
  constructor(hostRef) {
  ...
  render() {
    ...
    }), h("rtk-button", { kind: "button", variant: "secondary", onClick: this.onAddNewRoom, class: "add-room-jumbo-btn br-secondary-btn" }, h("div", null, h("rtk-icon", { icon: this.iconPack.add }), h("span", null, this.t("breakout_rooms.add_room_brief"))))))), h("div", { class: "participant-config-actions" }, h("div", { class: { "status-bar": true, "ephemeral-status": this.ephemeralStatusText !== "" } }, this.ephemeralStatusText !== "" && h("rtk-icon", { icon: this.iconPack.checkmark }), this.getStatusText()), h("div", { class: "breakout-actions" }, this.roomConfig.mode === "create" && this.permissions.canAlterConnectedMeetings && h("rtk-button", { size: "md", class: "start-breakout-button", onClick: () => this.enableConfirmationModal("start-breakout") }, this.t("breakout_rooms.start_breakout")), this.roomConfig.mode === "edit" && this.stateManager.hasLocalChanges && this.permissions.canAlterConnectedMeetings && h("rtk-button", { size: "md", class: "color-danger", variant: "ghost", onClick: () => this.discardChanges() }, this.t("breakout_rooms.discard_changes")), this.roomConfig.mode === "edit" && this.stateManager.hasLocalChanges && this.permissions.canAlterConnectedMeetings && h("rtk-button", { size: "md", class: "update-breakout-button", onClick: this.applyChanges }, this.t("breakout_rooms.update_breakout")), this.roomConfig.mode === "edit" && !this.stateManager.hasLocalChanges && this.permissions.canAlterConnectedMeetings && h("rtk-button", { size: "md", class: "close-breakout-button", onClick: () => this.enableConfirmationModal("close-breakout") }, this.t("breakout_rooms.close_breakout"))))));
  }
  static get watchers() {
    return {
...
var RtkBroadcastMessageModal = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.stateUpdate = createEvent(this, "rtkStateUpdate", 7);
    this.iconPack = defaultIconPack;
...
var RtkConfirmationModal = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.stateUpdate = createEvent(this, "rtkStateUpdate", 7);
...
var RtkJoinStageStyle0 = rtkJoinStageCss;
...
var RtkMuteAllConfirmation = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.stateUpdate = createEvent(this, "rtkStateUpdate", 7);
    this.iconPack = defaultIconPack;
...
var RtkPermissionsMessage = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.stateUpdate = createEvent(this, "rtkStateUpdate", 7);
    this.t = useLanguage();
  ...
  getMessage() {
    ...
    if (isDeniedBySystem) {
      ...
      return this.t(systemErrorKey) === systemErrorKey ? this.t(`perm_sys_denied.${this.mediaType}.others.message`) : this.t(systemErrorKey);
    }
    const browserErrorKey = `perm_denied.${this.mediaType}.${browser}.message`;
    return this.t(browserErrorKey) === browserErrorKey ? this.t(`perm_denied.${this.mediaType}.others.message`) : this.t(browserErrorKey);
  }
  render() {
    var _a, _b, _c;
    const isDeniedBySystem = this.isDeniedBySystem();
...
export {
  RtkBreakoutRoomsManager as rtk_breakout_rooms_manager,
  RtkBroadcastMessageModal as rtk_broadcast_message_modal,
  RtkConfirmationModal as rtk_confirmation_modal,
  RtkDebugger as rtk_debugger,
  RtkJoinStage as rtk_join_stage,
  RtkLeaveMeeting as rtk_leave_meeting,
  RtkMuteAllConfirmation as rtk_mute_all_confirmation,
  RtkOverlayModal as rtk_overlay_modal,
  RtkPermissionsMessage as rtk_permissions_message
};
//# sourceMappingURL=rtk-breakout-rooms-manager_9.entry-UZZIYT42.js.map
