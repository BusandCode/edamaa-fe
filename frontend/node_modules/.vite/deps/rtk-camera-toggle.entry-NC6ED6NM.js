...
// node_modules/@cloudflare/realtimekit-ui/dist/esm/rtk-camera-toggle.entry.js
var rtkCameraToggleCss = ":host{line-height:initial;font-family:var(--rtk-font-family, sans-serif);font-feature-settings:normal;font-variation-settings:normal}p{margin:var(--rtk-space-0, 0px);padding:var(--rtk-space-0, 0px)}:host{display:block}:host([data-hidden]){display:none}";
var RtkCameraToggleStyle0 = rtkCameraToggleCss;
...
var RtkCameraToggle = class {
  ...
  render() {
    ...
    return h(Host, { title: label }, h("rtk-tooltip", { kind: "block", label: tooltipLabel, part: "tooltip" }, h("rtk-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, class: classList, variant: this.variant, label, icon, onClick: this.toggleCamera, showWarning, disabled: disable })));
  }
  static get watchers() {
    return {
...
export {
  RtkCameraToggle as rtk_camera_toggle
};
//# sourceMappingURL=rtk-camera-toggle.entry-NC6ED6NM.js.map
