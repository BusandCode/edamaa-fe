...
// node_modules/@cloudflare/realtimekit-ui/dist/esm/rtk-screen-share-toggle.entry.js
var rtkScreenShareToggleCss = ":host{line-height:initial;font-family:var(--rtk-font-family, sans-serif);font-feature-settings:normal;font-variation-settings:normal}p{margin:var(--rtk-space-0, 0px);padding:var(--rtk-space-0, 0px)}:host{display:block}:host([data-hidden]){display:none}";
var RtkScreenShareToggleStyle0 = rtkScreenShareToggleCss;
...
var RtkScreenShareToggle = class {
  constructor(hostRef) {
...
export {
  RtkScreenShareToggle as rtk_screen_share_toggle
};
//# sourceMappingURL=rtk-screen-share-toggle.entry-RGC3YKGS.js.map
