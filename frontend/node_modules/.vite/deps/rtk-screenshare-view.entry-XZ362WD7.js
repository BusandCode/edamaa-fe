...
var RtkScreenshareView = class {
  ...
  render() {
    ...
    const icon = this.isFullScreen ? this.iconPack.full_screen_minimize : this.iconPack.full_screen_maximize;
    ...
    } }, h("rtk-icon", { key: "6140671792e626d5de181861ee4c7aef1dd11e3e", icon: this.videoExpanded ? this.iconPack.full_screen_minimize : this.iconPack.full_screen_maximize, slot: "start" }), this.videoExpanded ? this.t("screenshare.min_preview") : this.t("screenshare.max_preview")))), h("slot", { key: "beeecb6fe5a1f46d259a86e698c31fb477949bf3" }));
  }
  get host() {
...
export {
  RtkScreenshareView as rtk_screenshare_view
};
//# sourceMappingURL=rtk-screenshare-view.entry-XZ362WD7.js.map
