...
var OVERSCAN_BUFFER = 5;
var RtkMessageListView = class {
  constructor(hostRef) {
    ...
    this.elementObserver = /* @__PURE__ */ (() => {
      ...
      return {
        disconnect: () => {
          var _a;
          return (_a = get()) === null || _a === void 0 ? void 0 : _a.disconnect();
        },
        observe: (target) => {
          var _a;
          return (_a = get()) === null || _a === void 0 ? void 0 : _a.observe(target, { box: "border-box" });
        },
        unobserve: (target) => {
          var _a;
          return (_a = get()) === null || _a === void 0 ? void 0 : _a.unobserve(target);
        }
      };
    })();
    ...
    this.scrollToBottom = () => {
      ...
      writeTask(() => {
        ...
        if (this.getScrollHeight() - (this.getScrollTop() + this.getClientHeight()) > 0 && this.scrollToBottomRetries < 10) {
          setTimeout(() => {
            this.scrollToBottom();
          }, 1e3 / 60);
        } else {
...
export {
  RtkMessageListView as rtk_message_list_view
};
//# sourceMappingURL=rtk-message-list-view.entry-L3FDD6QM.js.map
