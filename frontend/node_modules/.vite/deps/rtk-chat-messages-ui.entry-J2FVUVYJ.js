...
var hasShownDeprecationWarning = false;
var RtkChatMessagesUi = class {
  constructor(hostRef) {
  ...
  connectedCallback() {
    ...
    this.lastReadTimestamp = (_a = chatUnreadTimestamps["everyone"]) !== null && _a !== void 0 ? _a : /* @__PURE__ */ new Date("0001-01-01T00:00:00Z");
        ...
        for (const entry of entries) {
          if (entry.isIntersecting) {
            ...
            if (currTimestamp > this.lastReadTimestamp.getTime()) {
              chatUnreadTimestamps[this.selectedGroup] = /* @__PURE__ */ new Date();
            }
          }
        }
      });
  ...
  chatChanged(messages) {
    ...
    for (let i = messages.length - 1; i >= 0; i--) {
      if (messages[i].message.time > this.lastReadTimestamp && messages[i].message.userId !== this.selfUserId) {
  ...
  render() {
    ...
    return h(Host, { key: "eb407b1c88839fd9892658dd53ea838b45b649ae" }, h("div", { key: "b3aa97bb11d4ce2fa688bb6171947505e3520b71", class: "chat-container scrollbar", ref: (el) => this.$chat = el, part: "container" }, h("div", { key: "8652876ea9af0bb1261718b412e34035cdbd905f", class: "spacer", part: "spacer" }), h("div", { key: "dd5caf3b54ff4378d75c3d2d4faec5dfaa79abb7", class: "chat", part: "chat" }, (_a = this.messages) === null || _a === void 0 ? void 0 : _a.map((item) => {
      if (item.type === "chat") {
        ...
        const isUnread = !isSelfMessage && !this.autoScrollEnabled && !reachedFirstUnread && message.time > this.lastReadTimestamp;
        if (isUnread)
          reachedFirstUnread = isUnread;
        const isContinued = !isUnread && message.userId === (prevMessage === null || prevMessage === void 0 ? void 0 : prevMessage.userId) && differenceInMinutes(message.time, prevMessage === null || prevMessage === void 0 ? void 0 : prevMessage.time) < 2;
        prevMessage = message;
...
export {
  RtkChatMessagesUi as rtk_chat_messages_ui
};
//# sourceMappingURL=rtk-chat-messages-ui.entry-J2FVUVYJ.js.map
