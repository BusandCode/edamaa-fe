import {
  ...
  offset,
  shift
} from "./chunk-ZHLYHMIT.js";
import {
  index
} from "./chunk-YMWEVWBA.js";
import {
  debounce
} from "./chunk-FSCE7DI4.js";
import {
  downloadFile,
  getExtension,
  getFileSize
} from "./chunk-GRPOJW7F.js";
import {
  formatName,
  getInitials,
  hasOnlyEmojis,
...
import {
  elapsedDuration,
  formatDateTime
} from "./chunk-V6N4A4IA.js";
import {
  Render
} from "./chunk-QF5BB5L4.js";
import {
  SyncWithStore
} from "./chunk-DP3S5342.js";
import {
  generateConfig
} from "./chunk-CQLDGSRW.js";
import {
  deepMerge,
  provideRtkDesignSystem
} from "./chunk-QKUG34YZ.js";
import {
  MAX_TEXT_LENGTH,
  extractReplyBlock,
...
var RtkChat = class {
  ...
  meetingChanged(meeting, oldMeeting) {
    ...
    if (meeting != null) {
      ...
      this.canPrivateMessage = !!(((_a = meeting.self.permissions.chatPrivate) === null || _a === void 0 ? void 0 : _a.canSend) || ((_b = meeting.self.permissions.chatPrivate) === null || _b === void 0 ? void 0 : _b.canReceive));
...
var RtkChatComposerView = class {
  constructor(hostRef) {
    ...
    this.handleSendMessage = () => {
      ...
      if (currentTime - messageLimits.startTime > this.rateLimits.period * 1e3) {
  ...
  checkRateLimitBreached(currentTime) {
    if (messageLimits.messagesSent >= this.rateLimits.maxInvocations) {
      ...
      const timeRemainingForReset = currentTime - messageLimits.startTime + this.rateLimits.period * 1e3;
      setTimeout(() => {
        messageLimits.messagesSent = 0;
...
var rtkChatMessagesUiPaginatedCss = ":host{display:flex;flex-direction:column;--tw-bg-opacity:1;background-color:rgba(var(--rtk-colors-background-900, 26 26 26) / var(--tw-bg-opacity));flex:1 0 0px}";
var RtkChatMessagesUiPaginatedStyle0 = rtkChatMessagesUiPaginatedCss;
...
var RtkChatMessagesUiPaginated = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    ...
    this.createChatNode = (message, isContinued) => {
      ...
      if (this.meeting.meta.viewType === "CHAT") {
        displayPicture = (_a = this.meeting.participants.all.toArray().find((p) => p.userId === message.userId)) === null || _a === void 0 ? void 0 : _a.picture;
      } else {
        if (this.meeting.self.userId === message.userId) {
          displayPicture = this.meeting.self.picture;
        } else {
          displayPicture = (_c = (_b = this.meeting.participants.joined.toArray().find((member) => member.userId === message.userId)) === null || _b === void 0 ? void 0 : _b.picture) !== null && _c !== void 0 ? _c : (_d = this.meeting.participants.waitlisted.toArray().find((p) => p.userId === message.userId)) === null || _d === void 0 ? void 0 : _d.picture;
        }
      }
      const isSelf = message.userId === this.meeting.self.userId;
      const viewType = isSelf ? "outgoing" : "incoming";
      return h("div", null, h("div", { class: "message-wrapper", id: message.id }, h("rtk-message-view", { messageType: message.type, pinned: message.pinned, isEdited: message.isEdited, time: message.time, actions: this.getMessageActions(message), authorName: message.displayName, isSelf, avatarUrl: displayPicture, hideAuthorName: isContinued, viewType, variant: "bubble", onAction: (event) => this.onMessageActionHandler(event.detail, message) }, h("div", null, h("div", { class: "body" }, message.type === "text" && h("rtk-text-message-view", { text: message.message, isMarkdown: true }), message.type === "file" && h("rtk-file-message-view", { name: message.name, url: message.link, size: message.size }), message.type === "image" && h("rtk-image-message-view", { url: message.link, onPreview: () => {
        this.stateUpdate.emit({ image: message });
      } }))))));
    };
    this.chatUpdateListener = (data) => {
      var _a, _b, _c;
      if (((_a = data.message.targetUserIds) === null || _a === void 0 ? void 0 : _a.length) > 0 && !data.message.targetUserIds.includes((_b = this.privateChatRecipient) === null || _b === void 0 ? void 0 : _b.userId))
        return;
...
var RtkChatSelector = class {
  constructor(hostRef) {
    ...
    this.pageSize = 1e5;
    this.pagesAllowed = 3;
    this.unreadMap = /* @__PURE__ */ new Map();
    this.disconnectMeeting = (meeting) => {
      var _a, _b, _c, _d;
    ...
    this.chatPermissionUpdateListener = () => {
      var _a, _b;
      this.showPrivateChat = !!(((_a = this.meeting.self.permissions.chatPrivate) === null || _a === void 0 ? void 0 : _a.canSend) || ((_b = this.meeting.self.permissions.chatPrivate) === null || _b === void 0 ? void 0 : _b.canReceive));
      if (!this.showPrivateChat) {
        this.selectedUser = void 0;
        this.chatSelectorChange.emit({ selectedUser: void 0 });
      }
    };
    this.onParticipantUpdate = () => {
      ...
      if (!participants.some((p) => {
        var _a2;
        return p.id === ((_a2 = this.selectedUser) === null || _a2 === void 0 ? void 0 : _a2.id);
      })) {
        this.selectedUser = void 0;
        this.chatSelectorChange.emit({ selectedUser: void 0 });
      }
    ...
    this.createPaticipantNodes = (data) => {
      return data.map((participant) => {
        var _a;
        return h("div", { class: "private-chat-label", id: participant.id, onClick: () => this.selectUser(participant) }, h("rtk-avatar", { size: "sm", participant }), h("span", null, (_a = participant.name) !== null && _a !== void 0 ? _a : this.t("participant")), this.unreadMap.get(participant.userId) ? h("div", { class: "private-chat-unread-badge" }) : null);
      });
    };
    this.chatUpdateListener = (data) => {
      var _a;
  ...
  overridesChanged(overrides) {
    ...
    if (!this.meeting || this.meeting.self)
      return;
    this.showPrivateChat = !!(((_a = this.meeting.self.permissions.chatPrivate) === null || _a === void 0 ? void 0 : _a.canSend) || ((_b = this.meeting.self.permissions.chatPrivate) === null || _b === void 0 ? void 0 : _b.canReceive)) && !overrides.disablePrivateChat;
  }
  meetingChanged(meeting, oldMeeting) {
    ...
    if (!meeting || !meeting.chat)
      return;
    this.showPrivateChat = !!(((_a = meeting.self.permissions.chatPrivate) === null || _a === void 0 ? void 0 : _a.canSend) || ((_b = meeting.self.permissions.chatPrivate) === null || _b === void 0 ? void 0 : _b.canReceive)) && !this.overrides.disablePrivateChat;
    this.onParticipantUpdate();
  ...
  render() {
    if (!this.showPrivateChat)
      return null;
    return h(Host, null, h("div", { class: "chat-header", onClick: this.toggle }, h("div", { class: "chat-header-label" }, this.selectedUser ? h("rtk-icon", { icon: this.iconPack.people, size: "sm" }) : h("rtk-icon", { icon: this.iconPack.participants, size: "sm" }), !this.selectedUser ? this.t("chat.everyone") : this.selectedUser.name), h("div", { class: "chevron" }, h("rtk-icon", { icon: this.isOpen ? this.iconPack.chevron_up : this.iconPack.chevron_down, size: "sm" }))), h("div", { class: { dropdown: true, open: this.isOpen, scrollbar: true } }, h("div", { class: "public-chat-group-label", onClick: () => this.selectUser(void 0) }, h("div", { class: "public-chat-icon" }, h("rtk-icon", { icon: this.iconPack.participants, size: "sm" })), this.t("chat.everyone")), h("rtk-paginated-list", { class: "chat-selector-paginated-list", ref: (el) => this.$paginatedListRef = el, pageSize: this.pageSize, pagesAllowed: 3, fetchData: this.getParticipants, createNodes: this.createPaticipantNodes, emptyListLabel: this.t("participants.empty_list") }, h("slot", null))));
  }
  static get watchers() {
    return {
...
var RtkDraftAttachmentView = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
...
var EMOJI_ASSET_URL = "https://rtk-assets.realtime.cloudflare.com/assets/emojis-data.json";
var cachedEmojis;
...
var RtkEmojiPicker = class {
  ...
  render() {
    return h(Host, { key: "db0bbe8c8af774ca199ac800fb2a0fba9ef7ab6d" }, h("div", { key: "3e51dd2b14a87ebc0c65ee406ec67f92722296ab", class: "close-parent" }, h("rtk-button", { key: "a8697bf95723f0598de3e2b6f88729562466ed81", variant: "ghost", kind: "icon", class: "close", onClick: () => {
      var _a;
      return (_a = this.pickerClose) === null || _a === void 0 ? void 0 : _a.emit();
...
var rtkEmojiPickerButtonCss = ":host{}";
var RtkEmojiPickerButtonStyle0 = rtkEmojiPickerButtonCss;
...
var RtkEmojiPickerButton = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.iconPack = defaultIconPack;
    this.t = useLanguage();
...
var rtkFilePickerButtonCss = ":host{}";
var RtkFilePickerButtonStyle0 = rtkFilePickerButtonCss;
...
var RtkFilePickerButton = class {
  ...
  disconnectedCallback() {
    this.fileInputField = void 0;
  }
  render() {
    const label = this.label || this.t("chat.send_file");
    const icon = this.iconPack[this.icon];
    return h("rtk-tooltip", { key: "c97c7e1e106e14f2443dd405fd6657a14d9d315c", label }, h("rtk-button", { key: "cffa7ef14cc7fe0285e642ca76b658b6c70d4b42", variant: "ghost", kind: "icon", onClick: () => this.uploadFile(), title: label }, h("rtk-icon", { key: "47133f919946ce2a63e4f2b64977f1127a4eae7c", icon })));
  }
};
__decorate$9([
  SyncWithStore()
...
var RtkMeeting = class {
  constructor(hostRef) {
    ...
    this.roomJoinedListener = () => {
      this.updateStates({ meeting: "joined", joinError: void 0 });
    };
    ...
    this.mediaPermissionUpdateListener = ({ kind, message }) => {
      if (["audio", "video"].includes(kind)) {
        if ((message === "DENIED" || message === "SYSTEM_DENIED") && (this.peerStore || uiStore).state.states.activeDebugger !== true) {
  ...
  connectedCallback() {
    ...
    if (this.applyDesignSystem && ((_a = this.config) === null || _a === void 0 ? void 0 : _a.designTokens) != null && typeof document !== "undefined" && (this.peerStore || uiStore).state.states.activeDebugger !== true) {
  ...
  meetingChanged(meeting) {
    ...
    if (this.loadConfigFromPreset && meeting.self.config != null) {
      ...
      if (meeting.connectedMeetings.supportsConnectedMeetings && ((_a = (this.peerStore || uiStore).state.states.activeBreakoutRoomsManager) === null || _a === void 0 ? void 0 : _a.destinationMeetingId)) {
        this.showSetupScreen = false;
      }
    }
    if (this.applyDesignSystem && ((_b = this.config) === null || _b === void 0 ? void 0 : _b.designTokens) != null && typeof document !== "undefined" && (this.peerStore || uiStore).state.states.activeDebugger !== true) {
      provideRtkDesignSystem(document.documentElement, this.config.designTokens);
    }
    ...
    if (meeting.self.roomJoined) {
      ...
      if (this.showSetupScreen) {
        ...
        meeting.joinRoom().then(() => {
          this.updateStates({ joinError: void 0 });
        }).catch((err) => {
  ...
  configChanged(config) {
    ...
    if ((config === null || config === void 0 ? void 0 : config.designTokens) && typeof document !== "undefined" && (this.peerStore || uiStore).state.states.activeDebugger !== true) {
  ...
  render() {
    ...
    return h(Render, { element: "rtk-meeting", defaults, asHost: true, elementProps });
  }
  get host() {
    return getElement(this);
  }
...
var RtkPaginatedList = class {
  ...
  async onNodeDelete(id) {
    ...
    for (let i = this.pages.length - 1; i >= 0; i--) {
      const index2 = this.pages[i].findIndex((node) => node.id === id);
      if (index2 === -1)
        continue;
      this.pages[i].splice(index2, 1);
  ...
  async onNodeUpdate(id, node) {
    for (let i = this.pages.length - 1; i >= 0; i--) {
      const index2 = this.pages[i].findIndex((node2) => node2.id === id);
      if (index2 === -1)
        continue;
      this.pages[i][index2] = Object.assign(Object.assign({}, this.pages[i][index2]), node);
      this.rerender();
      break;
    }
  }
    ...
    if (this.$containerRef) {
      this.$containerRef.onscrollend = async () => {
        if (this.shouldScrollToBottom)
          return;
        if (this.isInView(this.$bottomRef) && this.latestMessageTimestamp > this.latestPaginatedTimestamp) {
  ...
  async loadPrevPage() {
    ...
    if (this.oldestPaginatedTimestamp === 0)
      this.oldestPaginatedTimestamp = (/* @__PURE__ */ new Date()).getTime();
    this.isLoading = true;
  ...
  restoreScrollToAnchor(anchor) {
    ...
    const escapeId = (id) => {
      ...
      return typeof cssEscape === "function" ? cssEscape(id) : id.replace(/[^a-zA-Z0-9_-]/g, "\\$&");
    };
...
var RtkPinnedMessageSelector = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.dropdownToggle = createEvent(this, "rtkDropdownToggle", 7);
    ...
    this.createPinnedChatNodes = (messages) => {
      return messages.map((message) => {
        const preview = message.type === "text" ? (message.message || "").replace(/\s+/g, " ").trim() : message.type === "file" ? "File Attachment" : message.type === "image" ? "Image Attachment" : "";
...
export {
  RtkAvatar as rtk_avatar,
  RtkButton as rtk_button,
  RtkChat as rtk_chat,
  RtkChatComposerView as rtk_chat_composer_view,
  RtkChatHeader as rtk_chat_header,
  RtkChatMessagesUiPaginated as rtk_chat_messages_ui_paginated,
  RtkChatSelector as rtk_chat_selector,
  RtkDraftAttachmentView as rtk_draft_attachment_view,
  RtkEmojiPicker as rtk_emoji_picker,
  RtkEmojiPickerButton as rtk_emoji_picker_button,
  RtkFileMessageView as rtk_file_message_view,
  RtkFilePickerButton as rtk_file_picker_button,
  RtkIcon as rtk_icon,
  RtkImageMessageView as rtk_image_message_view,
  RtkMarkdownView as rtk_markdown_view,
  RtkMeeting as rtk_meeting,
  RtkMenu$1 as rtk_menu,
  RtkMenuItem as rtk_menu_item,
  RtkMenuList as rtk_menu_list,
  RtkMessageView as rtk_message_view,
  RtkPaginatedList as rtk_paginated_list,
  RtkPinnedMessageSelector as rtk_pinned_message_selector,
  RtkSpinner as rtk_spinner,
  RtkTextComposerView as rtk_text_composer_view,
  RtkTextMessageView as rtk_text_message_view,
  RtkMenu as rtk_tooltip
};
//# sourceMappingURL=rtk-avatar_26.entry-TWDJSZDE.js.map
