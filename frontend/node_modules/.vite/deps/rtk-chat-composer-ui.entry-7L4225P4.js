...
var RtkChatComposerUi = class {
  constructor(hostRef) {
    ...
    this.handleKeyDown = (e) => {
      if (e.key === MENTION_CHAR && [void 0, " "].includes(this.$textArea.value.at(-1))) {
    ...
    this.handleEditMessage = () => {
      ...
      if (((_a = this.prefill.editMessage) === null || _a === void 0 ? void 0 : _a.message) && replyBlockPattern.test(this.prefill.editMessage.message)) {
...
${editedMessage}`;
  ...
  render() {
    ...
    }, disabled: !!this.filePreview }), h("div", { key: "724a8e40a0384c4f11efca4d7abf081b110a7c9f", class: "chat-buttons", part: "chat-buttons" }, h("div", { key: "028b74f93d7b8ba1964460ea80ed4c63d56e5146", class: "left", part: "chat-buttons-left" }, !this.prefill.editMessage && this.canSendFiles && [
    ...
    } }, h("rtk-icon", { key: "4ee0c02bf3efc309a58db7be0f51545d6d346a9c", icon: this.iconPack.emoji_multiple })))), !!this.filePreview && this.renderFilePreview(), this.canSendTextMessage && h("div", { key: "a7d3f27cbe43f591363d1ffd8858f30d457e6629", class: "right", part: "chat-buttons-right" }, !this.prefill.editMessage && h("rtk-tooltip", { key: "57fc69e04c29b54cfb8510914659f0b94c3944eb", variant: "primary", label: this.t("chat.send_msg"), delay: 2e3 }, h("rtk-button", { key: "949e480cc2a243265f1268aff6396cd9bda20b03", kind: "icon", onClick: () => this.handleSendMessage(), title: this.t("chat.send_msg") }, h("rtk-icon", { key: "8fe5bc5391bef475805c86ab3fec94690bd71dfd", icon: this.iconPack.send }))), this.prefill.editMessage && h("div", { key: "3e87dae17dcac9be10a20fe15252756d496bf924", class: "edit-buttons" }, h("rtk-tooltip", { key: "201e7b44dc8a40cfc94bb299448a1e89c972ea92", variant: "secondary", label: this.t("cancel"), delay: 2e3 }, h("rtk-button", { key: "64d5dc9e41bc87a654c760c709b7b7d378f28141", kind: "icon", variant: "secondary", onClick: () => this.handleEditCancel(), title: this.t("cancel") }, h("rtk-icon", { key: "7e75e511da878e45f88b75c2f23a855a8c191b9b", icon: this.iconPack.dismiss }))), h("rtk-tooltip", { key: "df6284b88ac9651d5cb1c736b92fb929ee5795a1", variant: "primary", label: this.t("chat.update_msg"), delay: 2e3 }, h("rtk-button", { key: "c6b375320d193ccbf6658aa040302453ae361f91", kind: "icon", onClick: () => this.handleEditMessage(), title: this.t("chat.send_msg") }, h("rtk-icon", { key: "f047153809bc154526364f2e9a903449f83f51a9", icon: this.iconPack.checkmark }))))))));
  }
};
__decorate([
  SyncWithStore()
...
export {
  RtkChatComposerUi as rtk_chat_composer_ui
};
//# sourceMappingURL=rtk-chat-composer-ui.entry-7L4225P4.js.map
