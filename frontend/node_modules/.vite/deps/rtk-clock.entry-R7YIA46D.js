...
var addZero = (n) => Math.trunc(n).toString().padStart(2, "0");
var RtkClock = class {
  constructor(hostRef) {
  ...
  startedTimeChanged(startedTime) {
    if (startedTime !== void 0) {
      const animate = () => {
        this.timeDiff = (Date.now() - new Date(this.startedTime).getTime()) / 1e3;
  ...
  render() {
    const showClock = this.startedTime !== void 0;
    return h(Host, { key: "38836be8a2179a1cd5a01217bb9bcb39c5200b60", "data-hidden": !showClock, tabIndex: 0, role: "timer", "aria-live": "off" }, this.startedTime !== void 0 && [
...
export {
  RtkClock as rtk_clock
};
//# sourceMappingURL=rtk-clock.entry-R7YIA46D.js.map
