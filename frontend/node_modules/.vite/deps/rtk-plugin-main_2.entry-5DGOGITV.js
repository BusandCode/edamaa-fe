...
var RtkPluginMain = class {
  ...
  meetingChanged(meeting) {
    ...
    writeTask(() => {
      this.canClosePlugin = meeting.self.permissions.plugins.canClose || this.plugin.enabledBy === meeting.self.id;
    });
  }
...
var RtkTabBar = class {
  ...
  render() {
    return h(Host, { key: "1c4bce26c4c5baa19cd89be862922267c408ab97" }, h("rtk-spotlight-indicator", { key: "496f3634771c4b9c94ff64e23fa5695e2e1532e2", meeting: this.meeting, iconPack: this.iconPack, t: this.t, size: this.size }), this.tabs.map((tab) => {
      var _a, _b, _c, _d, _e;
      let isActive = false;
      if (((_a = this.activeTab) === null || _a === void 0 ? void 0 : _a.type) === "plugin" && tab.plugin && ((_b = this.activeTab) === null || _b === void 0 ? void 0 : _b.plugin.id) === tab.plugin.id)
        isActive = true;
      else if (((_c = this.activeTab) === null || _c === void 0 ? void 0 : _c.type) === "screenshare" && tab.participant && ((_d = this.activeTab) === null || _d === void 0 ? void 0 : _d.participant.id) === tab.participant.id)
        isActive = true;
...
export {
  RtkPluginMain as rtk_plugin_main,
  RtkTabBar as rtk_tab_bar
};
//# sourceMappingURL=rtk-plugin-main_2.entry-5DGOGITV.js.map
