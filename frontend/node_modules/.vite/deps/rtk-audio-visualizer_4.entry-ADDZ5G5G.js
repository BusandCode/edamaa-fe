...
// node_modules/@cloudflare/realtimekit-ui/dist/esm/rtk-audio-visualizer_4.entry.js
var drawBarsVisualizer = (canvas, volume) => {
  if (canvas == null) {
    return;
  }
  const nSlices = 3;
  ...
  const sliceWidth = width * 1 / sample.length;
...
var RtkAudioVisualizer = class {
  ...
  disconnectedCallback() {
    ...
    this.audioUpdateListener && ((_b = this.participant) === null || _b === void 0 ? void 0 : _b.removeListener("audioUpdate", this.audioUpdateListener));
    this.screenShareUpdateListener && ((_c = this.participant) === null || _c === void 0 ? void 0 : _c.removeListener("screenShareUpdate", this.screenShareUpdateListener));
  }
...
var RtkMicrophoneSelector = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.iconPack = defaultIconPack;
    this.variant = "full";
    ...
    this.currentDevices = { audio: void 0 };
...
var RtkSpeakerSelector = class {
  constructor(hostRef) {
    ...
    this.t = useLanguage();
    this.speakerDevices = [];
    this.currentDevices = { speaker: void 0 };
    this.deviceListUpdateListener = async () => {
  ...
  meetingChanged(meeting) {
    ...
    writeTask(async () => {
      ...
      if (currentSpeakerDevice != void 0) {
        this.speakerDevices = [
...
export {
  RtkAudioVisualizer as rtk_audio_visualizer,
  RtkMicrophoneSelector as rtk_microphone_selector,
  RtkSpeakerSelector as rtk_speaker_selector,
  RtkSwitch as rtk_switch
};
//# sourceMappingURL=rtk-audio-visualizer_4.entry-ADDZ5G5G.js.map
