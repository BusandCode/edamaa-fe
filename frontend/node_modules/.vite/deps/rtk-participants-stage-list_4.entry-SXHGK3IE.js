...
var RtkParticipants = class {
  constructor(hostRef) {
    ...
    this.createParticipantNode = (participant) => {
      ...
      return h("div", null, h(Render, { element: "rtk-participant", defaults, props: { role: "listitem", participant, key: participant.id }, childProps: Object.assign(Object.assign({}, defaults), { participant, size: this.size }), deepProps: true }));
    };
...
var RtkParticipantsStaged = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.config = createDefaultConfig();
    this.iconPack = defaultIconPack;
...
var RtkParticipantsViewers = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    ...
    this.stageViewers = [];
    this.createParticipantNode = (participant) => {
      return h("rtk-participant", { role: "listitem", key: participant.id, meeting: this.meeting, participant, view: this.view, iconPack: this.iconPack, config: this.config, t: this.t });
    };
...
var RtkParticipantsWaitlisted = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.config = createDefaultConfig();
    this.iconPack = defaultIconPack;
...
export {
  RtkParticipants as rtk_participants_stage_list,
  RtkParticipantsStaged as rtk_participants_stage_queue,
  RtkParticipantsViewers as rtk_participants_viewer_list,
  RtkParticipantsWaitlisted as rtk_participants_waiting_list
};
//# sourceMappingURL=rtk-participants-stage-list_4.entry-SXHGK3IE.js.map
