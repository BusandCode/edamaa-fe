...
const RealtimeKitContext = createContext({
  meeting: void 0,
  updates: void 0
});
function RealtimeKitProvider({
  ...
  return /* @__PURE__ */ React.createElement(RealtimeKitContext.Provider, {
    value: { meeting: value, updates }
  }, value ? children : fallback);
}
const useRealtimeKitMeeting = () => {
...
const initRTKMedia = (options = {}, skipAwaits = false, cachedUserDetails = void 0) => RTKClient.initMedia(options, skipAwaits, cachedUserDetails);
const useRealtimeKitClient = (clientParams) => {
  ...
  const initClient = useCallback(async (options) => {
    ...
    return RTKClient.init(options).then((meeting) => {
      setClient(meeting);
      return meeting;
    }).finally(() => {
...
const useRealtimeKitSelector = (selector) => {
...
export { RealtimeKitContext, RealtimeKitProvider, initRTKMedia, useRealtimeKitClient, useRealtimeKitMeeting, useRealtimeKitSelector };
