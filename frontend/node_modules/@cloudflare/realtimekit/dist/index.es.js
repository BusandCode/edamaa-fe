var xS = Object.defineProperty, US = Object.defineProperties;
var $S = Object.getOwnPropertyDescriptors;
var Fc = Object.getOwnPropertySymbols, FS = Object.getPrototypeOf, $h = Object.prototype.hasOwnProperty, Fh = Object.prototype.propertyIsEnumerable, BS = Reflect.get;
var Bh = Math.pow, Wl = (s, t, e) => t in s ? xS(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : s[t] = e, O = (s, t) => {
  for (var e in t || (t = {}))
...
var a = (s, t, e) => (Jl(s, t, "read from private field"), e ? e.call(s) : t.get(s)), m = (s, t, e) => {
  if (t.has(s))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(s) : t.set(s, e);
}, S = (s, t, e, r) => (Jl(s, t, "write to private field"), r ? r.call(s, e) : t.set(s, e), e);
var x = (s, t, e) => (Jl(s, t, "access private method"), e), Hh = (s, t, e) => BS(FS(s), e, t);
...
import { v4 as tn, validate as Ng } from "uuid";
import Vg from "bowser";
import { MessageType as T, PbLong as Qa, typeofJsonValue as HS } from "@protobuf-ts/runtime";
import * as Xc from "worker-timers";
...
}, yo = "chrome", Lg = "opera", xg = "firefox", Ug = "iexplorer", $g = "safari", Fg = "nwjs", Bg = "electron", Hg = "react-native", sh = "unknown", hd = {
  Chrome: yo,
  Chromium: yo,
  Opera: Lg,
  Firefox: xg,
...
class QS {
  ...
  init(t) {
    let e, r;
    if (this._bowser = Vg.getParser(navigator.userAgent), typeof t == "undefined") {
   ...
   */
  isReactNative() {
    return this._name === Hg || navigator.isReactNative === !0;
  }
  /**
...
}, _n = typeof Reflect == "object" ? Reflect : null, qh = _n && typeof _n.apply == "function" ? _n.apply : function(t, e, r) {
...
function iv(s, t) {
  return new Promise(function(e, r) {
    ...
    Yg(s, t, n, { once: !0 }), t !== "error" && nv(s, i, { once: !0 });
  });
}
function nv(s, t, e) {
...
class cv extends ot {
  ...
  callEvent(e) {
    e.timestamp = new Date(), this.eventStore.add(e), this.emit(e.event, e.metaData), av.get(e.event) === z.MAJOR_EVENT && this.flush();
  }
  flush() {
    return u(this, null, function* () {
      var r;
...
const Qg = 240, Xg = 720, Zg = 8, em = 3, Pl = 10, _l = 0.02, Cl = 0.03;
...
class pr {
  ...
  onIceCandidate(t, e) {
    if (e.candidate) {
      const r = pr.parseCandidate(e.candidate.candidate);
    ...
    for (const A of c.values()) {
      ...
      switch (A.type) {
        ...
        case "candidate-pair": {
          ...
          f.push(Te), (A.nominated === !0 || A.selected === !0) && (d.candidatePair = Te);
          break;
        }
        case "transport": {
          const y = A;
    ...
    this.onSafeInitialization(() => {
      ...
      switch (e) {
        ...
        case "PlayerRecoverableError":
          (f = this.backend) == null || f.sendIVSPlayerRecoverableErrorEvent(r, i);
          break;
...
var kv = Array.prototype, Iv = kv.splice;
function Av(s) {
  var t = this.__data__, e = Rl(t, s);
  if (e < 0)
    return !1;
  var r = t.length - 1;
  return e == r ? t.pop() : Iv.call(t, e, 1), --this.size, !0;
}
function Mv(s) {
  var t = this.__data__, e = Rl(t, s);
...
const gm = Uv;
var $v = typeof self == "object" && self && self.Object === Object && self, Fv = gm || $v || Function("return this")();
const Ps = Fv;
var Bv = Ps.Symbol;
const Ls = Bv;
var mm = Object.prototype, Hv = mm.hasOwnProperty, qv = mm.toString, Xa = Ls ? Ls.toStringTag : void 0;
function jv(s) {
...
var Gv = Object.prototype, Wv = Gv.toString;
function Jv(s) {
  return Wv.call(s);
}
var Kv = "[object Null]", zv = "[object Undefined]", Yh = Ls ? Ls.toStringTag : void 0;
function nn(s) {
...
var Yv = "[object AsyncFunction]", Qv = "[object Function]", Xv = "[object GeneratorFunction]", Zv = "[object Proxy]";
function ih(s) {
  if (!is(s))
    return !1;
  var t = nn(s);
...
var sT = Function.prototype, rT = sT.toString;
function an(s) {
  if (s != null) {
    try {
      return rT.call(s);
...
var iT = /[\\^$.*+?()[\]{}|]/g, nT = /^\[object .+?Constructor\]$/, aT = Function.prototype, oT = Object.prototype, cT = aT.toString, dT = oT.hasOwnProperty, lT = RegExp(
...
var ST = "__lodash_hash_undefined__", vT = Object.prototype, TT = vT.hasOwnProperty;
function yT(s) {
  var t = this.__data__;
  if (Po) {
    var e = t[s];
...
var LT = Object.prototype, xT = LT.hasOwnProperty;
function fm(s, t, e) {
  var r = s[t];
...
var Sm = Object.prototype, FT = Sm.hasOwnProperty, BT = Sm.propertyIsEnumerable, HT = Xh(function() {
  return arguments;
}()) ? Xh : function(s) {
...
var vm = typeof exports == "object" && exports && !exports.nodeType && exports, Zh = vm && typeof module == "object" && module && !module.nodeType && module, GT = Zh && Zh.exports === vm, ep = GT ? Ps.Buffer : void 0, WT = ep ? ep.isBuffer : void 0, JT = WT || jT;
const ba = JT;
...
var QT = "[object Arguments]", XT = "[object Array]", ZT = "[object Boolean]", ey = "[object Date]", ty = "[object Error]", sy = "[object Function]", ry = "[object Map]", iy = "[object Number]", ny = "[object Object]", ay = "[object RegExp]", oy = "[object Set]", cy = "[object String]", dy = "[object WeakMap]", ly = "[object ArrayBuffer]", uy = "[object DataView]", hy = "[object Float32Array]", py = "[object Float64Array]", gy = "[object Int8Array]", my = "[object Int16Array]", fy = "[object Int32Array]", Sy = "[object Uint8Array]", vy = "[object Uint8ClampedArray]", Ty = "[object Uint16Array]", yy = "[object Uint32Array]", ve = {};
ve[hy] = ve[py] = ve[gy] = ve[my] = ve[fy] = ve[Sy] = ve[vy] = ve[Ty] = ve[yy] = !0;
ve[QT] = ve[XT] = ve[ly] = ve[ZT] = ve[uy] = ve[ey] = ve[ty] = ve[sy] = ve[ry] = ve[iy] = ve[ny] = ve[ay] = ve[oy] = ve[cy] = ve[dy] = !1;
function Ey(s) {
...
var Tm = typeof exports == "object" && exports && !exports.nodeType && exports, po = Tm && typeof module == "object" && module && !module.nodeType && module, Py = po && po.exports === Tm, zl = Py && gm.process, _y = function() {
  try {
...
const ka = _y;
var tp = ka && ka.isTypedArray, Cy = tp ? ch(tp) : Ey;
const bl = Cy;
var Ry = Object.prototype, wy = Ry.hasOwnProperty;
function ym(s, t) {
...
const Iy = ky;
var Ay = Object.prototype, My = Ay.hasOwnProperty;
function Pm(s) {
  if (!kl(s))
    return Iy(s);
  var t = [];
...
function Mc(s) {
  return Ac(s) ? ym(s, !0) : Ly(s);
}
function xy(s, t) {
  return s && Ic(t, Mc(t), s);
}
var _m = typeof exports == "object" && exports && !exports.nodeType && exports, sp = _m && typeof module == "object" && module && !module.nodeType && module, Uy = sp && sp.exports === _m, rp = Uy ? Ps.Buffer : void 0, ip = rp ? rp.allocUnsafe : void 0;
function Cm(s, t) {
  if (t)
    return s.slice();
...
var Fy = Object.prototype, By = Fy.propertyIsEnumerable, np = Object.getOwnPropertySymbols, Hy = np ? function(s) {
...
const lh = jy;
var Gy = Object.getOwnPropertySymbols, Wy = Gy ? function(s) {
  for (var t = []; s; )
    bm(t, dh(s)), s = lh(s);
  return t;
} : wm;
...
const uu = Xy;
var ap = "[object Map]", Zy = "[object Object]", op = "[object Promise]", cp = "[object Set]", dp = "[object WeakMap]", lp = "[object DataView]", eE = an(du), tE = an(Eo), sE = an(lu), rE = an(Cn), iE = an(uu), ri = nn;
...
const Ia = ri;
var nE = Object.prototype, aE = nE.hasOwnProperty;
function oE(s) {
...
var up = Ls ? Ls.prototype : void 0, hp = up ? up.valueOf : void 0;
function hE(s) {
...
var pE = "[object Boolean]", gE = "[object Date]", mE = "[object Map]", fE = "[object Number]", SE = "[object RegExp]", vE = "[object Set]", TE = "[object String]", yE = "[object Symbol]", EE = "[object ArrayBuffer]", PE = "[object DataView]", _E = "[object Float32Array]", CE = "[object Float64Array]", RE = "[object Int8Array]", wE = "[object Int16Array]", bE = "[object Int32Array]", kE = "[object Uint8Array]", IE = "[object Uint8ClampedArray]", AE = "[object Uint16Array]", ME = "[object Uint32Array]";
function DE(s, t, e) {
  var r = s.constructor;
  switch (t) {
    case EE:
...
var pp = Object.create, OE = function() {
  function s() {
  }
  return function(t) {
    if (!is(t))
...
var gp = ka && ka.isMap, xE = gp ? ch(gp) : LE;
const UE = xE;
var $E = "[object Set]";
function FE(s) {
  return xs(s) && Ia(s) == $E;
}
var mp = ka && ka.isSet, BE = mp ? ch(mp) : FE;
const HE = BE;
var qE = 1, jE = 2, GE = 4, Dm = "[object Arguments]", WE = "[object Array]", JE = "[object Boolean]", KE = "[object Date]", zE = "[object Error]", Om = "[object Function]", YE = "[object GeneratorFunction]", QE = "[object Map]", XE = "[object Number]", Nm = "[object Object]", ZE = "[object RegExp]", eP = "[object Set]", tP = "[object String]", sP = "[object Symbol]", rP = "[object WeakMap]", iP = "[object ArrayBuffer]", nP = "[object DataView]", aP = "[object Float32Array]", oP = "[object Float64Array]", cP = "[object Int8Array]", dP = "[object Int16Array]", lP = "[object Int32Array]", uP = "[object Uint8Array]", hP = "[object Uint8ClampedArray]", pP = "[object Uint16Array]", gP = "[object Uint32Array]", ge = {};
ge[Dm] = ge[WE] = ge[iP] = ge[nP] = ge[JE] = ge[KE] = ge[aP] = ge[oP] = ge[cP] = ge[dP] = ge[lP] = ge[QE] = ge[XE] = ge[Nm] = ge[ZE] = ge[eP] = ge[tP] = ge[sP] = ge[uP] = ge[hP] = ge[pP] = ge[gP] = !0;
ge[zE] = ge[Om] = ge[rP] = !1;
...
function ph(s, t) {
  if (Ut(s))
    return !1;
  var e = typeof s;
  return e == "number" || e == "symbol" || e == "boolean" || s == null || Al(s) ? !0 : TP.test(s) || !vP.test(s) || t != null && s in Object(t);
}
...
var _P = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, CP = /\\(\\)?/g, RP = PP(function(s) {
  var t = [];
...
var kP = 1 / 0, fp = Ls ? Ls.prototype : void 0, Sp = fp ? fp.toString : void 0;
function Vm(s) {
  if (typeof s == "string")
    return s;
  if (Ut(s))
...
function DP(s, t, e) {
  t = Lm(t, s);
  for (var r = -1, i = t.length, n = !1; ++r < i; ) {
    var o = Ml(t[r]);
    if (!(n = s != null && e(s, o)))
      break;
    s = s[o];
...
var hr = /* @__PURE__ */ ((s) => (s.GroupCall = "GROUP_CALL", s.Webinar = "WEBINAR", s.AudioRoom = "AUDIO_ROOM", s.Livestream = "LIVESTREAM", s.Chat = "CHAT", s))(hr || {}), H = /* @__PURE__ */ ((s) => (s.Allowed = "ALLOWED", s.NotAllowed = "NOT_ALLOWED", s.CanRequest = "CAN_REQUEST", s))(H || {}), Um = "hXgU8Wc8pwuGNq9ms5q9Hh", gg;
    ...
    return u(this, arguments, function* ({
      ...
      for (const g of h)
        try {
          ...
          o.error("Flagsmith identify failed!!", { error: f, url: g });
        }
      return {};
    });
  }
...
wo = new WeakMap();
var Hs, qs;
const xh = class extends ot.EventEmitter {
  constructor(e) {
    super();
    m(this, Hs, void 0);
    m(this, qs, void 0);
...
var Tp = 0 / 0, XP = /^[-+]0x[0-9a-f]+$/i, ZP = /^0b[01]+$/i, e_ = /^0o[0-7]+$/i, t_ = parseInt;
function yp(s) {
  if (typeof s == "number")
    return s;
  if (Al(s))
...
function y_(s, t, e) {
  if (!is(e))
    return !1;
  var r = typeof t;
  return (r == "number" ? Ac(e) && ah(t, e.length) : r == "string" && t in e) ? kc(e[t], s) : !1;
}
function E_(s) {
...
var P_ = "[object Object]", __ = Function.prototype, C_ = Object.prototype, qm = __.toString, R_ = C_.hasOwnProperty, w_ = qm.call(Object);
function b_(s) {
  if (!xs(s) || nn(s) != P_)
    return !1;
  var t = lh(s);
...
function Gm(s, t, e, r, i, n) {
  ...
  return n.delete(s), n.delete(t), f;
}
function L_(s) {
...
var x_ = 1, U_ = 2, $_ = "[object Boolean]", F_ = "[object Date]", B_ = "[object Error]", H_ = "[object Map]", q_ = "[object Number]", j_ = "[object RegExp]", G_ = "[object Set]", W_ = "[object String]", J_ = "[object Symbol]", K_ = "[object ArrayBuffer]", z_ = "[object DataView]", Pp = Ls ? Ls.prototype : void 0, Yl = Pp ? Pp.valueOf : void 0;
...
function eC(s, t, e, r, i, n) {
  ...
  for (var _ = o; ++g < d; ) {
    ...
    var I = s[f], M = t[f];
    if (r)
      var U = o ? r(M, I, f, t, s, n) : r(I, M, f, s, t, n);
  ...
  if (C && !_) {
    ...
    L != B && "constructor" in s && "constructor" in t && !(typeof L == "function" && L instanceof L && typeof B == "function" && B instanceof B) && (C = !1);
  }
  return n.delete(s), n.delete(t), C;
}
var tC = 1, _p = "[object Arguments]", Cp = "[object Array]", Hc = "[object Object]", sC = Object.prototype, Rp = sC.hasOwnProperty;
function rC(s, t, e, r, i, n) {
  ...
  return f ? (n || (n = new Es()), eC(s, t, e, r, i, n)) : !1;
}
function Dl(s, t, e, r, i) {
  return s === t ? !0 : s == null || t == null || !xs(s) && !xs(t) ? s !== s && t !== t : rC(s, t, e, r, Dl, i);
}
var iC = 1, nC = 2;
function aC(s, t, e, r) {
...
function vh(s, t, e) {
  ...
  function M(G) {
    return c = void 0, f && r ? v(G) : (r = i = void 0, o);
  }
  function U() {
...
var IC = "[object Map]", AC = "[object Set]", MC = Object.prototype, DC = MC.hasOwnProperty;
function OC(s) {
  if (s == null)
    return !0;
...
const Pr = VC;
var LC = 1 / 0, xC = Cn && 1 / Sh(new Cn([, -0]))[1] == LC ? function(s) {
  return new Cn(s);
} : r_;
const UC = xC;
var $C = 200;
function zm(s, t, e) {
  var r = -1, i = S_, n = s.length, o = !0, c = [], d = c;
  if (e)
    o = !1, i = kC;
  else if (n >= $C) {
    var l = t ? null : UC(s);
...
var mu = /* @__PURE__ */ ((s) => (s.PARTICIPANT = "PARTICIPANT", s.PEER = "PEER", s.CLIENT = "CLIENT", s))(mu || {});
const te = {
...
const WC = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="m16.242 2.932 4.826 4.826a2.75 2.75 0 0 1-.715 4.404l-4.87 2.435a.75.75 0 0 0-.374.426l-1.44 4.166a1.25 1.25 0 0 1-2.065.476L8.5 16.561 4.06 21H3v-1.06l4.44-4.44-3.105-3.104a1.25 1.25 0 0 1 .476-2.066l4.166-1.44a.75.75 0 0 0 .426-.373l2.435-4.87a2.75 2.75 0 0 1 4.405-.715Zm3.766 5.886-4.826-4.826a1.25 1.25 0 0 0-2.002.325l-2.435 4.871a2.25 2.25 0 0 1-1.278 1.12l-3.789 1.31 6.705 6.704 1.308-3.789a2.25 2.25 0 0 1 1.12-1.277l4.872-2.436a1.25 1.25 0 0 0 .325-2.002Z" fill="currentColor"/></svg>', JC = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M4 12.02c0 1.06.2 2.1.6 3.08l.6 1.42c.22.55.64 1.01 1.17 1.29.27.14.56.21.86.21h2.55c.77 0 1.49-.41 1.87-1.08.5-.87 1.02-1.7 1.72-2.43l1.32-1.39c.44-.46.97-.84 1.49-1.23l.59-.45a.6.6 0 0 0 .23-.47c0-.75-.54-1.57-1.22-1.79a3.34 3.34 0 0 0-2.78.29V4.5a1.5 1.5 0 0 0-2.05-1.4 1.5 1.5 0 0 0-2.9 0A1.5 1.5 0 0 0 6 4.5v.09A1.5 1.5 0 0 0 4 6v6.02ZM8 4.5v4a.5.5 0 0 0 1 0v-5a.5.5 0 0 1 1 0v5a.5.5 0 0 0 1 0v-4a.5.5 0 0 1 1 0v6a.5.5 0 0 0 .85.37h.01c.22-.22.44-.44.72-.58.7-.35 2.22-.57 2.4.5l-.53.4c-.52.4-1.04.78-1.48 1.24l-1.33 1.38c-.75.79-1.31 1.7-1.85 2.63-.21.36-.6.58-1.01.58H7.23a.87.87 0 0 1-.4-.1 1.55 1.55 0 0 1-.71-.78l-.59-1.42a7.09 7.09 0 0 1-.53-2.7V6a.5.5 0 0 1 1 0v3.5a.5.5 0 0 0 1 0v-5a.5.5 0 0 1 1 0Z" fill="currentColor"></path></svg>', qc = (s) => {
  if (!s)
    return;
  if (!s.startsWith("<svg"))
...
const Uh = class extends Bt {
    ...
    for (; c < a(this, we).height - 5; ) {
      ...
      for (; g < a(this, we).width - 5 && d < i; ) {
        if ((l = o[d]) != null && l.enabled) {
          const f = o[d].element, [v, E, C, _, I, M, U, L] = rR(
            g,
            c,
            e,
            r,
  ...
  cleanup() {
    if (S(this, An, !1), this.isSupported() && document.exitPictureInPicture !== void 0 && document.pictureInPictureElement !== null && document.exitPictureInPicture(), a(this, tt))
      try {
  ...
  init({ height: e, width: r } = {}) {
    ...
    if (a(this, An))
      return;
    S(this, An, !0), this.createCanvas(), this.setupMediaSessionEvents();
    const i = document.createElement("video");
    S(this, we, {
      height: e != null ? e : kp,
      width: r != null ? r : Ip
    }), i.height = a(this, we).height, i.width = a(this, we).width, i.autoplay = !0, i.muted = !0, i.srcObject = a(this, Gt).captureStream(24), S(this, Wt, i), a(this, Wt).onloadedmetadata = () => {
      try {
  ...
  enableSource(e) {
    a(this, lt)[e] !== void 0 && (a(this, lt)[e].enabled = !0);
  }
  /**
   * @param {string} source
   */
  disableSource(e) {
    a(this, lt)[e] !== void 0 && (a(this, lt)[e].enabled = !1);
  }
  generateAvatar(e, r) {
    return u(this, null, function* () {
      if (!r)
...
let fu = Uh;
Gt = new WeakMap(), ui = new WeakMap(), tt = new WeakMap(), Wt = new WeakMap(), we = new WeakMap(), ds = new WeakMap(), js = new WeakMap(), lt = new WeakMap(), De = new WeakMap(), kn = new WeakMap(), In = new WeakMap(), Gs = new WeakMap(), An = new WeakMap();
var gr;
(function(s) {
...
class Cb extends T {
  constructor() {
    super("socket.room.Peer", [
      ...
      { no: 4, name: "stage_type", kind: "enum", opt: !0, T: () => ["socket.room.StageType", cr, "STAGE_TYPE_"] },
      {
        no: 5,
...
class wb extends T {
  constructor() {
    super("socket.room.PeerStatusUpdate", [
      ...
      { no: 3, name: "stage_type", kind: "enum", opt: !0, T: () => ["socket.room.StageType", cr, "STAGE_TYPE_"] }
    ]);
  }
}
const xp = new wb();
...
class wk extends T {
  constructor() {
    super("socket.room.BroadcastMessage", [
      ...
      { no: 5, name: "broadcast_type", kind: "enum", opt: !0, T: () => ["socket.room.BroadcastType", Eu, "BROADCAST_TYPE_"] }
    ]);
  }
}
const eo = new wk();
...
class Yk extends T {
  constructor() {
    super("socket.preset.PresetUpdates", [
      ...
      { no: 16, name: "waiting_room_type", kind: "enum", opt: !0, T: () => ["socket.preset.WaitingRoomType", Pu, "WAITING_ROOM_TYPE_"] },
      {
        no: 17,
        name: "is_recorder",
        kind: "scalar",
      ...
      { no: 18, name: "recorder_type", kind: "enum", opt: !0, T: () => ["socket.room.RecorderType", yu, "RECORDER_TYPE_"] },
      {
        no: 19,
        name: "hidden_participant",
        kind: "scalar",
...
class ZA extends T {
  ...
  now() {
    ...
    return t.seconds = Qa.from(Math.floor(e / 1e3)).toBigInt(), t.nanos = e % 1e3 * 1e6, t;
  }
  /**
   * Converts a `Timestamp` to a JavaScript Date.
   */
  toDate(t) {
    return new Date(Qa.from(t.seconds).toNumber() * 1e3 + Math.ceil(t.nanos / 1e6));
  }
  /**
  ...
  fromDate(t) {
    ...
    return e.seconds = Qa.from(Math.floor(r / 1e3)).toBigInt(), e.nanos = r % 1e3 * 1e6, e;
  }
  /**
  ...
  internalJsonWrite(t, e) {
    let r = Qa.from(t.seconds).toNumber() * 1e3;
  ...
  internalJsonRead(t, e, r) {
    if (typeof t != "string")
      throw new Error("Unable to parse Timestamp from JSON " + HS(t) + ".");
    ...
    return r || (r = this.create()), r.seconds = Qa.from(n / 1e3).toBigInt(), r.nanos = 0, i[7] && (r.nanos = parseInt("1" + i[7] + "0".repeat(9 - i[7].length)) - 1e9), r;
  }
}
new ZA();
class eM extends T {
...
new sM();
const rM = 0, iM = 1, nM = 2, aM = 3, oM = 5, cM = {
  getPeerInfo: 0,
  updatePeerInfo: 1,
  getRoomPeersInfo: 2,
  joinRoom: 3,
...
const $ = Oc(rM, cM), $e = Oc(iM, dM), J = Oc(
  nM,
  lM
), Bs = Oc(aM, uM), br = pf(hf, 16777216), ys = pf(hf, 50331648), sd = Oc(
  oM,
  hM
);
var pM = Object.defineProperty, gM = Object.getOwnPropertyDescriptor, Zr = (s, t, e, r) => {
  for (var i = r > 1 ? void 0 : r ? gM(t, e) : t, n = s.length - 1, o; n >= 0; n--)
    (o = s[n]) && (i = (r ? o(t, e, i) : o(i)) || i);
  return r && i && pM(t, e, i), i;
}, ss = /* @__PURE__ */ ((s) => (s[s.TEXT = 0] = "TEXT", s[s.IMAGE = 1] = "IMAGE", s[s.FILE = 2] = "FILE", s[s.CUSTOM = 3] = "CUSTOM", s))(ss || {}), Mt, Mn;
class vr {
  constructor(t, e) {
    m(this, Mt, void 0);
    m(this, Mn, void 0);
  ...
  constructor(t, e) {
    ...
    this.requests.request = (h) => u(this, null, function* () {
      ...
      try {
        ...
        throw I ? (((f = I.config) == null ? void 0 : f.url) !== g.logsEndpoint && this.logger.error("xhr::fetch", {
          error: I,
          networkCall: {
            status: I.status,
            statusText: I.statusText,
...
var EM = Object.defineProperty, PM = Object.getOwnPropertyDescriptor, Us = (s, t, e, r) => {
  ...
  getPlugins() {
    return u(this, null, function* () {
      ...
      return (l = (d = (c = this.context.getValue("modules")) == null ? void 0 : c.devTools) == null ? void 0 : d.plugins) != null && l.length && ((g = (h = this.context.getValue("modules")) == null ? void 0 : h.devTools) == null || g.plugins.forEach((f) => {
        ...
        const v = j(O({}, Za), {
          tags: [...Za.tags],
          baseUrl: `http://localhost:${f.port}`,
          name: f.name,
          picture: (E = f.picture) != null ? E : Za.picture,
          createdAt: new Date().toISOString(),
          updatedAt: new Date().toISOString(),
          id: f.id,
          organizationId: this.organizationId,
          description: (C = f.description) != null ? C : Za.description,
          staggered: (_ = f.staggered) != null ? _ : Za.staggered
        });
        i.v2.push(v);
      })), i.v2;
    });
...
var CM = Object.defineProperty, RM = Object.getOwnPropertyDescriptor, Rs = (s, t, e, r) => {
  for (var i = r > 1 ? void 0 : r ? RM(t, e) : t, n = s.length - 1, o; n >= 0; n--)
    (o = s[n]) && (i = (r ? o(t, e, i) : o(i)) || i);
  return r && i && CM(t, e, i), i;
};
const wM = ["text", "image", "file", "custom", "poll"], rd = { maxInvocations: 180, period: 60 };
var re, hi, We, Dn, Id, mf, bo, wu, mg;
let $t = (mg = class extends Bt {
  /**
   * @param {Context} context
  ...
  pin(t) {
    return u(this, null, function* () {
      ...
      try {
        yield a(this, We).setPinState(t, !0);
      } catch (e) {
  ...
  unpin(t) {
    return u(this, null, function* () {
      ...
      try {
        yield a(this, We).setPinState(t, !1);
      } catch (e) {
        throw new k(`No message found with id: ${t}`, "0504");
      }
    });
...
}, re = new WeakMap(), hi = new WeakMap(), We = new WeakMap(), Dn = new WeakMap(), Id = new WeakSet(), mf = function() {
  return a(this, Dn).getValue("connectionHandler");
}, bo = new WeakSet(), wu = function() {
  return a(this, Id, mf).socketJoined === !0;
}, mg);
Rs([
...
var bM = Object.defineProperty, kM = Object.getOwnPropertyDescriptor, IM = (s, t, e, r) => {
...
var AM = Object.defineProperty, MM = Object.getOwnPropertyDescriptor, DM = (s, t, e, r) => {
  for (var i = r > 1 ? void 0 : r ? MM(t, e) : t, n = s.length - 1, o; n >= 0; n--)
    (o = s[n]) && (i = (r ? o(t, e, i) : o(i)) || i);
  return r && i && AM(t, e, i), i;
}, Ad, ff, Md, Sf, On, Nn, ko, Sg;
let bu = (Sg = class extends Bt {
  constructor(t, e, r) {
...
}, Ad = new WeakSet(), ff = function() {
  return a(this, ko).getValue("connectionHandler");
}, Md = new WeakSet(), Sf = function() {
  var t;
  return ((t = a(this, Ad, ff)) == null ? void 0 : t.socketJoined) === !0;
}, On = new WeakMap(), Nn = new WeakMap(), ko = new WeakMap(), Sg);
bu = DM([
  ct("0700")
], bu);
var OM = Object.defineProperty, NM = Object.getOwnPropertyDescriptor, VM = (s, t, e, r) => {
...
}, kr = new WeakMap(), Vn = new WeakMap(), gi = new WeakMap(), vg);
let vf = pn;
VM([
  P.trace("PollController.setupEvents")
], vf.prototype, "setupEvents", 1);
var LM = Object.defineProperty, xM = Object.getOwnPropertyDescriptor, UM = (s, t, e, r) => {
  for (var i = r > 1 ? void 0 : r ? xM(t, e) : t, n = s.length - 1, o; n >= 0; n--)
    (o = s[n]) && (i = (r ? o(t, e, i) : o(i)) || i);
  return r && i && LM(t, e, i), i;
}, Tf = /* @__PURE__ */ ((s) => (s[s.User = 0] = "User", s[s.Meeting = 1] = "Meeting", s))(Tf || {}), Ln, Io, Iu, mi, Ao, Tg;
let ku = (Tg = class extends Bt {
  /**
   * @param {Context} context
   * @param {Self} self
...
}, Ln = new WeakMap(), Io = new WeakSet(), Iu = function() {
  return a(this, Ln).getValue("connectionHandler");
}, mi = new WeakMap(), Ao = new WeakMap(), Tg);
ku = UM([
  ct("0800")
], ku);
function $M(s) {
...
var FM = Object.defineProperty, BM = Object.getOwnPropertyDescriptor, yf = (s, t, e, r) => {
  for (var i = r > 1 ? void 0 : r ? BM(t, e) : t, n = s.length - 1, o; n >= 0; n--)
    (o = s[n]) && (i = (r ? o(t, e, i) : o(i)) || i);
  return r && i && FM(t, e, i), i;
}, Mo, yg;
let Yr = (yg = class extends Bt {
  constructor(t) {
...
var HM = Object.defineProperty, qM = Object.getOwnPropertyDescriptor, jM = (s, t, e, r) => {
...
}, Ir = new WeakMap(), xn = new WeakMap(), Dt = new WeakMap(), Eg);
let Pf = Ef;
jM([
...
var GM = Object.defineProperty, WM = Object.getOwnPropertyDescriptor, cn = (s, t, e, r) => {
  for (var i = r > 1 ? void 0 : r ? WM(t, e) : t, n = s.length - 1, o; n >= 0; n--)
    (o = s[n]) && (i = (r ? o(t, e, i) : o(i)) || i);
  return r && i && GM(t, e, i), i;
}, Jt, Dd, ie, Do, bs, Je, Oo, Au, Un, id;
class ei extends Bt {
  /**
   * @param {Context} context
   * @param {Self} self
  ...
  join() {
    return u(this, null, function* () {
      ...
      if (a(this, Je).setValue("stageStatus", "ON_STAGE", !1), yield a(this, Jt).joinStage(), e === hr.Livestream) {
  ...
  leave() {
    return u(this, null, function* () {
      ...
      a(this, ie).setIsPinned(!1), a(this, Je).setValue("stageStatus", "OFF_STAGE", !1), yield a(this, Jt).leaveStage(a(this, ie).userId);
      try {
...
Jt = new WeakMap(), Dd = new WeakMap(), ie = new WeakMap(), Do = new WeakMap(), bs = new WeakMap(), Je = new WeakMap(), Oo = new WeakSet(), Au = function() {
  return a(this, Je).getValue("roomNodeClient");
}, Un = new WeakSet(), id = function(e) {
  return u(this, null, function* () {
...
var KM = Object.defineProperty, zM = Object.getOwnPropertyDescriptor, YM = (s, t, e, r) => {
...
class _f {
  ...
  selfStageStatusHandler(t) {
    ...
    if (r !== e)
      switch (t.stageType) {
        case 1:
          a(this, ut).setValue("stageStatus", "ACCEPTED_TO_JOIN_STAGE", !1), this.stage.join();
          break;
        case 2:
        case 3:
        ...
        case 4:
        default:
          a(this, ut).setValue("stageStatus", "ACCEPTED_TO_JOIN_STAGE", !1), this.stage.leave();
          break;
      }
  }
  /**
...
Ar = new WeakMap(), ls = new WeakMap(), Mr = new WeakMap(), No = new WeakMap(), ut = new WeakMap();
YM([
  P.trace("Stage.setupEvents")
], _f.prototype, "setupEvents", 1);
var QM = Object.defineProperty, XM = Object.getOwnPropertyDescriptor, Nl = (s, t, e, r) => {
  for (var i = r > 1 ? void 0 : r ? XM(t, e) : t, n = s.length - 1, o; n >= 0; n--)
    (o = s[n]) && (i = (r ? o(t, e, i) : o(i)) || i);
...
var st, Ot, $n, Fn, Ws, Bn, Dr, Hn, Pg;
let Ma = (Pg = class extends Da {
  /**
   * @param {Context} context
  ...
  activateForSelf() {
    return u(this, null, function* () {
      ...
      S(this, Bn, e), S(this, Ws, new Date());
      try {
  ...
  deactivateForSelf() {
    ...
    }), S(this, Ws, void 0), this.iframes.clear(), this.setActive(!1), this.emit("closed");
  }
  /**
   * @deprecated
   */
  ...
  activate() {
    return u(this, null, function* () {
      var t, e;
      this.active || (e = (t = a(this, Ot).permissions) == null ? void 0 : t.plugins) != null && e.canStart && (a(this, st).addPlugin(this.id, this.staggered), S(this, Ws, new Date()), this.logger.info("plugin::activated", {
        plugin: {
          id: this.id,
    ...
    return u(this, null, function* () {
      ...
      this.active && (!((e = (t = a(this, Ot).permissions) == null ? void 0 : t.plugins) != null && e.canClose) && this.enabledBy !== a(this, Ot).id || (a(this, st).removePlugin(this.id), this.logger.info("plugin::deactivated", {
        plugin: {
          id: this.id,
          name: this.name,
          duration: a(this, Ws) ? new Date().getTime() - a(this, Ws).getTime() : 0
        }
      }), S(this, Ws, void 0)));
    });
  }
}, st = new WeakMap(), Ot = new WeakMap(), $n = new WeakMap(), Fn = new WeakMap(), Ws = new WeakMap(), Bn = new WeakMap(), Dr = new WeakMap(), Hn = new WeakMap(), Pg);
Nl([
...
var ZM = Object.defineProperty, e0 = Object.getOwnPropertyDescriptor, t0 = (s, t, e, r) => {
...
var s0 = Object.defineProperty, r0 = Object.getOwnPropertyDescriptor, Vl = (s, t, e, r) => {
...
}, Kt = new WeakMap(), qn = new WeakMap(), us = new WeakMap(), _g);
let Nc = Rf;
Vl([
...
Vo = new WeakMap();
var n0 = Object.defineProperty, a0 = Object.getOwnPropertyDescriptor, Vc = (s, t, e, r) => {
  for (var i = r > 1 ? void 0 : r ? a0(t, e) : t, n = s.length - 1, o; n >= 0; n--)
    (o = s[n]) && (i = (r ? o(t, e, i) : o(i)) || i);
  return r && i && n0(t, e, i), i;
}, jn, Gn, Wn, nd, Cg;
let rn = (Cg = class extends Bt {
  constructor(t, e) {
...
}, jn = new WeakMap(), Gn = new WeakMap(), Wn = new WeakSet(), nd = function(t, e, r) {
  return u(this, null, function* () {
    if (!a(this, jn).permissions.canRecord)
...
var o0 = Object.defineProperty, c0 = Object.getOwnPropertyDescriptor, d0 = (s, t, e, r) => {
...
class l0 {
  ...
  hasFeature(t) {
    var e;
    return (e = a(this, vi).getValue("flagsmith").hasFeature(t)) != null ? e : !1;
  }
  getFeatureValue(t) {
...
var u0 = Object.defineProperty, h0 = Object.getOwnPropertyDescriptor, Ht = (s, t, e, r) => {
  for (var i = r > 1 ? void 0 : r ? h0(t, e) : t, n = s.length - 1, o; n >= 0; n--)
    (o = s[n]) && (i = (r ? o(t, e, i) : o(i)) || i);
  return r && i && u0(t, e, i), i;
}, Be, Se, he, Js, zt, Lo, be;
class bt extends Da {
  constructor(e, r, i = yd, n = !0) {
    const o = e.getValue("logger");
    super(o);
    m(this, Be, void 0);
    m(this, Se, void 0);
  ...
  enableAudio(e) {
    return u(this, null, function* () {
      if (!this.audioUpdateInProgress) {
        ...
        try {
          e ? yield a(this, Se).enableTrack(!1, e) : yield a(this, Se).unmuteTrack();
        } catch (r) {
        } finally {
  ...
  enableVideo(e) {
    return u(this, null, function* () {
      if (!this.videoUpdateInProgress) {
        ...
        try {
          e ? yield a(this, he).enableTrack(!1, e) : yield a(this, he).unmuteTrack();
        } catch (r) {
        } finally {
  ...
  onDeviceChange(e, r) {
    return u(this, null, function* () {
      ...
      (n = e == null ? void 0 : e.added) == null || n.reverse().forEach((c) => u(this, null, function* () {
        var d;
        c && !yd(c) && (c.kind === "audioinput" && ((d = this.audioTrack) == null ? void 0 : d.enabled) === !0 ? yield this.setAudioDevice(c, { saveDevicePreference: !1 }) : c.kind === "audiooutput" && (i = !0, yield this.setSpeakerDevice(c, { saveDevicePreference: !1 })));
...
Be = new WeakMap(), Se = new WeakMap(), he = new WeakMap(), Js = new WeakMap(), zt = new WeakMap(), Lo = new WeakMap(), be = new WeakMap();
Ht([
...
function yd(s) {
  ...
  return ((r = _e._bowser) == null ? void 0 : r.getOSName()) === "macOS" && t.includes("iphone") ? !0 : p0.some(
...
class m0 {
  ...
  terminateMiddlewareWebWorker() {
    if (a(this, Ti))
      try {
        Xc.clearInterval(a(this, Ti)), S(this, Ti, void 0);
      } catch (t) {
  ...
  getTransformedVideoTrack(t, e, r) {
    return u(this, null, function* () {
      ...
      o.addEventListener(
        "play",
        () => {
          i.width = o.width || e.getSettings().width, i.height = o.width || e.getSettings().height, S(this, Ti, Xc.setInterval(
            l,
            50
          ));
        },
...
var ue = /* @__PURE__ */ ((s) => (s.WEBCAM = "webcam", s.WEBCAM_BACKUP = "webcam_backup", s.MIC = "mic", s.SCREENSHARE_VIDEO = "screenshare_video", s.SCREENSHARE_AUDIO = "screenshare_audio", s))(ue || {});
const T0 = GP(), un = Vs(
  T0.config.media
);
function y0(s) {
...
var _0 = Object.defineProperty, C0 = Object.getOwnPropertyDescriptor, ws = (s, t, e, r) => {
  for (var i = r > 1 ? void 0 : r ? C0(t, e) : t, n = s.length - 1, o; n >= 0; n--)
    (o = s[n]) && (i = (r ? o(t, e, i) : o(i)) || i);
  return r && i && _0(t, e, i), i;
}, Jn, Yt, Ne, Rg;
let Ft = (Rg = class extends P0 {
  constructor(t, e) {
    super();
    m(this, Jn, void 0);
    m(this, Yt, void 0);
  ...
  getVideoTrack(t) {
    return u(this, null, function* () {
      ...
      try {
        const f = a(this, Yt).getVideoConstraints(c), v = yield d(f);
        ...
        throw f.constraints && this.handlePermissionErrors("video", f), new k(f.message, "1602");
      }
    });
  }
      ...
      const t = (e) => u(this, null, function* () {
        try {
          ...
          const i = zc(
            ...
            r.name,
            r.message
          ), n = new nu(r.name, r.message, e), o = { video: !0 };
        ...
        navigator.mediaDevices.addEventListener(
          ...
          (r) => u(this, null, function* () {
            ...
            if (e = o, (l = d.added) != null && l.length || (h = d.removed) != null && h.length) {
              ...
              g.some((f) => f.kind === "audioinput") && a(this, Ne).getValue("callstats").devices("AUDIO", o == null ? void 0 : o.filter((f) => f.kind === "audioinput")), g.some((f) => f.kind === "videoinput") && a(this, Ne).getValue("callstats").devices("VIDEO", o == null ? void 0 : o.filter((f) => f.kind === "videoinput")), g.some((f) => f.kind === "audiooutput") && a(this, Ne).getValue("callstats").devices("SPEAKER", o == null ? void 0 : o.filter((f) => f.kind === "audiooutput")), t(r, d, !1);
            }
          }),
...
}, Jn = new WeakMap(), Yt = new WeakMap(), Ne = new WeakMap(), Rg);
ws([
...
const bf = Ft, en = {
  ...
  function d() {
    return c ? Promise.resolve(!0) : (n.getByteTimeDomainData(o), o.some((l) => l !== 128 && l !== 0) ? Promise.resolve(!1) : R0().then(d));
  }
  return d().then(
    (l) => (i.disconnect(), l),
    (l) => {
...
function A0(s) {
  ...
  let r = k0;
  function i() {
    return r -= 1, w0(e, s.srcObject, I0).then((n) => n ? r > 0 ? i() : !0 : !1).catch(() => !0);
  }
  return i().finally(() => {
    tg.release(t);
  });
...
var M0 = Object.defineProperty, D0 = Object.getOwnPropertyDescriptor, kf = (s, t, e, r) => {
  for (var i = r > 1 ? void 0 : r ? D0(t, e) : t, n = s.length - 1, o; n >= 0; n--)
    (o = s[n]) && (i = (r ? o(t, e, i) : o(i)) || i);
  return r && i && M0(t, e, i), i;
};
let Ed = class extends Da {
  /**
...
const If = Ed;
var O0 = Object.defineProperty, N0 = Object.getOwnPropertyDescriptor, wh = (s, t, e, r) => {
  for (var i = r > 1 ? void 0 : r ? N0(t, e) : t, n = s.length - 1, o; n >= 0; n--)
    (o = s[n]) && (i = (r ? o(t, e, i) : o(i)) || i);
  return r && i && O0(t, e, i), i;
};
const au = "[Realtimekit]nonSilentDeviceLabels";
class Ll extends If {
  onSetDevice(t) {
    return u(this, null, function* () {
      if (!t)
...
Uo = new WeakMap();
const $0 = U0;
var F0 = Object.defineProperty, B0 = Object.getOwnPropertyDescriptor, xl = (s, t, e, r) => {
...
let Du = Tn;
ht = new WeakMap(), Pi = new WeakMap(), Fo = new WeakMap(), zn = new WeakMap();
var q0 = Object.defineProperty, j0 = Object.getOwnPropertyDescriptor, Af = (s, t, e, r) => {
...
var G0 = Object.defineProperty, W0 = Object.getOwnPropertyDescriptor, J0 = (s, t, e, r) => {
...
class Mf {
  ...
  setupEvents() {
    a(this, Ks).on(
      ...
      (t) => u(this, null, function* () {
        var e;
        ((e = t.flags) == null ? void 0 : e.hiddenParticipant) === !0 && t.recorderType === "LIVESTREAMER" && (S(this, Qn, t.id), this.livestream.setLivestreamState("LIVESTREAMING"));
      })
...
Qn = new WeakMap(), Xn = new WeakMap(), Ks = new WeakMap(), ks = new WeakMap();
J0([
  P.trace("LivestreamController.setupEvents")
], Mf.prototype, "setupEvents", 1);
var K0 = Object.defineProperty, z0 = Object.getOwnPropertyDescriptor, xc = (s, t, e, r) => {
...
rt = new WeakMap(), Nr = new WeakMap(), Vr = new WeakMap(), Od = new WeakSet(), Df = function(t, e, r = !0) {
  let i;
...
_i = new WeakMap(), Ci = new WeakMap(), Ho = new WeakSet(), Ou = function() {
  return a(this, qo).getValue("peerId");
}, qo = new WeakMap(), Lr = new WeakMap(), Nd = new WeakSet(), Of = function() {
  [
    J.storeInsertKeys,
    J.storeGetKeys,
    J.storeDeleteKeys
    ...
    a(this, _i).on(
      ...
      (e) => u(this, null, function* () {
        ...
        i !== void 0 && (t === J.storeInsertKeys && r.forEach(({ key: c, peerId: d, payload: l }) => {
          d !== a(this, Ho, Ou) && i.set(c, l, !1, !0);
        }), t === J.storeDeleteKeys && r.forEach(({ key: c, peerId: d }) => {
          d !== a(this, Ho, Ou) && i.delete(c, !1, !0);
        }));
      })
    );
  });
...
var Q0 = Object.defineProperty, X0 = Object.getOwnPropertyDescriptor, Va = (s, t, e, r) => {
  for (var i = r > 1 ? void 0 : r ? X0(t, e) : t, n = s.length - 1, o; n >= 0; n--)
    (o = s[n]) && (i = (r ? o(t, e, i) : o(i)) || i);
  return r && i && Q0(t, e, i), i;
};
const Z0 = 0.8, eD = 1.2;
var Zn, ea, Nt, Ri, ro, xr, gn, wi, io, Vd, Nf, zs, jo, Ur, bi, no, Ys, Ld, Go, Nu, xd, Vf, Ud, Lf, wg;
let mr = (wg = class extends Bt {
  /**
   * @param {Context} context
  ...
  constructor(t, e, r, i) {
    ...
    */
    ...
    m(this, Ld, vh((t) => {
      ...
      d > eD && a(this, Ys) === 1 ? (S(this, Ys, 0), a(this, Nt).getValue("peerSessionStore").emit(w.MAX_SPATIAL_LAYER_CHANGE, {
        peerId: this.id,
        maxSpatialLayer: a(this, Ys)
      })) : d < Z0 && a(this, Ys) === 0 && (S(this, Ys, 1), a(this, Nt).getValue("peerSessionStore").emit(w.MAX_SPATIAL_LAYER_CHANGE, {
        peerId: this.id,
        maxSpatialLayer: a(this, Ys)
      }));
    }, 2e3));
...
const xf = new rD();
var iD = Object.defineProperty, nD = Object.getOwnPropertyDescriptor, qt = (s, t, e, r) => {
  for (var i = r > 1 ? void 0 : r ? nD(t, e) : t, n = s.length - 1, o; n >= 0; n--)
    (o = s[n]) && (i = (r ? o(t, e, i) : o(i)) || i);
  return r && i && iD(t, e, i), i;
};
const aD = ["ACTIVE_GRID", "PAGINATED", "MANUAL"];
var ye, Wo, Vu, ki, ao, ta, ad, Ii, Et, bg;
let Tt = (bg = class extends Bt {
  /**
  ...
  setupEvents() {
    a(this, ye).getValue("peerSessionStore").on(w.E2EE_ACTIVE_CONSUMER, ({ peerId: e }) => {
      var r;
      ((r = a(this, ye).getValue("modules").e2ee) == null ? void 0 : r.enabled) !== !0 && this.emit("media_decode_error", {
...
}, ye = new WeakMap(), Wo = new WeakSet(), Vu = function() {
  return a(this, ye).getValue("roomNodeClient");
}, ki = new WeakSet(), ao = function() {
  var t;
  return ((t = a(this, ye).getValue("connectionHandler")) == null ? void 0 : t.socketJoined) === !0;
}, ta = new WeakSet(), ad = function() {
  var t;
  return ((t = a(this, ye).getValue("connectionHandler")) == null ? void 0 : t.mediaJoined) === !0;
}, Ii = new WeakMap(), Et = new WeakMap(), bg);
qt([
...
var oD = Object.defineProperty, cD = Object.getOwnPropertyDescriptor, dn = (s, t, e, r) => {
...
const Uf = (kg = class {
  ...
  setupEvents() {
    this.roomSocketHandler.on(
      ...
      ({ participants: s, selectedPeers: t, roomState: e }) => {
        ...
        e.pinnedPeerIds.length !== 0 && this.onParticipantPinned(e.pinnedPeerIds[0]), this.computeActivateParticipants(r != null ? r : [], i), this.logger.info("selfJoinComplete: Emitting UPDATE_ACTIVE with createAllConsumers=true"), this.context.getValue("peerSessionStore").emit(w.UPDATE_ACTIVE, { createAllConsumers: !0 });
      }
  ...
  syncConsumers() {
    return u(this, null, function* () {
      ...
      if (a(this, hs)) {
        S(this, sa, !0), this.logger.info("syncConsumers: Sync in progress, marking resyncRequired=true and exiting.");
        return;
      }
      this.logger.info("syncConsumers: Starting sync operation."), S(this, hs, !0), S(this, sa, !1);
      let s = [];
      this.participants.videoSubscribed.forEach((g) => {
        var E, C;
        const f = this.participants.joined.get(g.id), v = (C = (E = g.producers) == null ? void 0 : E.filter((_) => _.kind === "video")) != null ? C : [];
        f && (v != null && v.length) && v.forEach((_) => {
          var U, L, B, G;
          const I = ((L = (U = f.manualProducerConfig) == null ? void 0 : U.video) != null ? L : !0) && _.kind === "video" && !_.screenShare, M = ((G = (B = f.manualProducerConfig) == null ? void 0 : B.screenshareVideo) != null ? G : !0) && _.kind === "video" && _.screenShare;
          (I || M) && (_.pause || s.push(_));
        });
      }), this.participants.audioSubscribed.forEach((g) => {
        var E, C;
        const f = this.participants.joined.get(g.id), v = (C = (E = g.producers) == null ? void 0 : E.filter((_) => _.kind === "audio")) != null ? C : [];
        f && (v != null && v.length) && v.forEach((_) => {
          var U, L, B, G;
          const I = ((L = (U = f.manualProducerConfig) == null ? void 0 : U.audio) != null ? L : !0) && _.kind === "audio" && !_.screenShare, M = ((G = (B = f.manualProducerConfig) == null ? void 0 : B.screenshareAudio) != null ? G : !0) && _.kind === "audio" && _.screenShare;
          (I || M) && s.push(_);
        });
      ...
      try {
        ...
        this.logger.info("syncConsumers: Setting consumersSyncing=false and completing sync."), S(this, hs, !1);
      }
  ...
  */
  ...
  setupEventsGlobal() {
    ...
    })), this.context.getValue("peerSessionStore").on(w.UPDATE_ACTIVE, (...r) => u(this, [...r], function* ({ viewMode: s, page: t, createAllConsumers: e } = { viewMode: "ACTIVE_GRID", page: 0, createAllConsumers: !1 }) {
  ...
  onParticipantLeave(s) {
    return u(this, null, function* () {
      const t = this.participants.joined.get(s);
      this.participants.joined.delete(s, !0, !0), this.participants.pinned.delete(s, !0, !0), this.participants.waitlisted.delete(s, !0, !0), this.roomNodeClient && (this.roomNodeClient.handlePeerLeaving(s), this.roomNodeClient.closeConsumers(t == null ? void 0 : t.producers)), t && t.stageStatus === "REQUESTED_TO_JOIN_STAGE" && this.context.getValue("peerSessionStore").emit(w.UPDATE_STAGE_REQUESTS, {
        request: {
          displayName: t.name,
          userId: t.userId,
          peerId: t.id
  ...
  processConsumerPaused(s) {
    ...
    h && (h.consumer = {
      ...
      rtpReceiver: c,
      localId: d
    }), r && i.e2ee && this.context.getValue("peerSessionStore").emit(w.E2EE_INACTIVE_CONSUMER, { peerId: t, trackId: r.id }), e === "video" ? (l.videoTrack = r, l.setVideoEnabled(!1), this.updatePipSource(l.id, !1), this.context.getValue("callstats").consumerSharedMediaState(s, { video: !1 })) : e === "audio" && (l.audioTrack = r, l.setAudioEnabled(l.audioEnabled), this.context.getValue("callstats").consumerSharedMediaState(s, {
...
}, Qt = new WeakMap(), hs = new WeakMap(), sa = new WeakMap(), kg);
let yr = Uf;
dn([
...
const yn = class extends Bt {
  constructor(e, r, i, n = !1) {
    ...
    m(this, $d, (e) => {
      ...
      if (r && (r.private && Pr(a(this, q).chat.private, r.private), r.public && Pr(a(this, q).chat.public, r.public), this.emit("chatUpdate")), i && Pr(a(this, q).connectedMeetings, i), c) {
        const v = (C) => {
          switch (C) {
            case Jr.NONE:
              return H.Allowed;
      ...
      n && (Pr(a(this, q).plugins, n), this.emit("pluginsUpdate")), o && (Pr(a(this, q).polls, o), this.emit("pollsUpdate")), Object.keys(d).length !== 0 && Pr(a(this, q), d), this.emit("permissionsUpdate", e);
    });
    if (!r)
  ...
  static init(e, r, i) {
    let n;
    return i ? n = new yn(e, i, r, !0) : n = new yn(e, me, r), n;
  }
  // eslint-disable-next-line class-methods-use-this
  get mediaRoomType() {
    return "CF";
...
let Lu = yn;
q = new WeakMap(), ra = new WeakMap(), ia = new WeakMap(), $d = new WeakMap(), pt = new WeakSet(), It = function() {
      ...
      if (_e.init(), i && S(this, Vt, i), !this.localMediaHandler)
        try {
          ...
          if ((n = i == null ? void 0 : i.getValue("defaults")) != null && n.mediaHandler)
            f = !1, this.localMediaHandler = i.getValue("defaults").mediaHandler.localMediaHandler;
          ...
          this.logger.error("Self::init::Failed To Setup Streams", {
            error: { name: f.name, message: f.message }
          });
        }
    });
  }
  ...
  setDevice(e) {
    return u(this, null, function* () {
      switch (e.kind) {
        case "audioinput":
          try {
            yield this.localMediaHandler.setAudioDevice(e, { saveDevicePreference: !0 });
          } catch (r) {
          } finally {
          ...
          break;
        case "audiooutput":
          yield this.localMediaHandler.setSpeakerDevice(e, { saveDevicePreference: !0 });
          break;
        case "videoinput":
          try {
            yield this.localMediaHandler.setVideoDevice(e, { saveDevicePreference: !0 });
          } catch (r) {
          } finally {
...
Vt = new WeakMap();
var dD = Object.defineProperty, lD = Object.getOwnPropertyDescriptor, yt = (s, t, e, r) => {
  for (var i = r > 1 ? void 0 : r ? lD(t, e) : t, n = s.length - 1, o; n >= 0; n--)
    (o = s[n]) && (i = (r ? o(t, e, i) : o(i)) || i);
  return r && i && dD(t, e, i), i;
}, na, gt, aa, Ue, Qs, ii, He, Xe, oa, od, Ve, Fe, ca, da, Jo, xu, Ig;
let Qe = (Ig = class extends $f {
  constructor(t, e, r, i, n) {
    var c;
    const o = t.getValue("logger");
    super(t, o);
  ...
  get roomJoined() {
    var t;
    return a(this, na).viewType === hr.Livestream && this.stageStatus !== "ON_STAGE" ? ((t = a(this, Ue).getValue("connectionHandler")) == null ? void 0 : t.socketJoined) === !0 : a(this, Ve, Fe);
  }
  /**
    ...
    return u(this, null, function* () {
      ...
      switch (t.kind) {
        case "audioinput":
          ...
          break;
        case "audiooutput":
          yield this.localMediaHandler.setSpeakerDevice(t, { saveDevicePreference: !0 });
          break;
        case "videoinput":
          try {
...
}, na = new WeakMap(), gt = new WeakMap(), aa = new WeakMap(), Ue = new WeakMap(), Qs = new WeakSet(), ii = function() {
  return a(this, Ue).getValue("pip");
}, He = new WeakSet(), Xe = function() {
  return a(this, Ue).getValue("roomNodeClient");
}, oa = new WeakSet(), od = function() {
  return a(this, Ue).getValue("audioPlayback");
}, Ve = new WeakSet(), Fe = function() {
  var t;
  return ((t = a(this, Ue).getValue("connectionHandler")) == null ? void 0 : t.mediaJoined) === !0;
}, ca = new WeakMap(), da = new WeakMap(), Jo = new WeakSet(), xu = function() {
  Array.from(a(this, da)).forEach((t) => this.updateVideo(t, !1)), Array.from(a(this, ca)).forEach((t) => this.updateVideo(t, !0));
}, Ig);
yt([
...
class kh extends Error {
  constructor(t) {
    super(t != null ? t : "AwaitQueue stopped"), this.name = "AwaitQueueStoppedError", typeof Error.captureStackTrace == "function" && Error.captureStackTrace(this, kh);
  }
}
class Ih extends Error {
  constructor(t) {
    super(t != null ? t : "AwaitQueue task removed"), this.name = "AwaitQueueRemovedTaskError", typeof Error.captureStackTrace == "function" && Error.captureStackTrace(this, Ih);
  }
}
var Ko;
class Uu {
...
class Ro extends Error {
  constructor(t) {
    super(t), this.name = "UnsupportedError", Error.hasOwnProperty("captureStackTrace") ? Error.captureStackTrace(this, Ro) : this.stack = new Error(t).stack;
  }
}
class Rt extends Error {
  constructor(t) {
    super(t), this.name = "InvalidStateError", Error.hasOwnProperty("captureStackTrace") ? Error.captureStackTrace(this, Rt) : this.stack = new Error(t).stack;
  }
}
...
const ig = (s) => new Promise((t) => setTimeout(t, s));
function Ff(s, t) {
  return u(this, null, function* () {
...
Ke = new WeakMap();
var Rn = /* @__PURE__ */ ((s) => (s.NEW = "new", s.CONNECTING = "connecting", s.RECONNECTING = "reconnecting", s.DISCONNECTED = "disconnected", s.CONNECTED = "connected", s.FAILED = "failed", s.CLOSED = "closed", s))(Rn || {}), zo;
class Ul extends ot.EventEmitter {
  constructor(e) {
    super();
    m(this, zo, void 0);
      ...
      if (!navigator.isReactNative) {
        ...
        r && r.length && r.forEach((g) => {
          ...
          if (g.parameters) {
            ...
            const E = ((v = f.sdpFmtpLine) == null ? void 0 : v.split(";")) || [];
            E.push(...g.parameters);
  ...
  send(n) {
    return u(this, arguments, function* ({
      ...
      if (yield this.pc.setLocalDescription(l), t === "audio" || t.kind === "audio") {
        ...
        l.sdp = l.sdp.replace(
          "minptime=10;useinbandfec=1",
          `minptime=10;useinbandfec=1;${f ? "usedtx=1;" : ""}${g ? "stereo=1;sprop-stereo=1;" : ""}maxaveragebitrate=${v}`
        );
      }
...
var Yo, Ai, Is, Fd, As, Cr, Qo, $u, Bd, Bf, Hd, Hf;
class SD extends Ul {
  constructor(e, r) {
    var i;
    super(e);
   ...
   */
  close(e, r) {
    a(this, Is) || (this.logger.debug(`Consumer::close() ${e ? `with reason ${e}` : ""}`, a(this, As, Cr)), S(this, Is, !0), r && (x(this, Hd, Hf).call(this), this.transceiver.stop()), this.safeEmit("close", e));
  }
  /**
  ...
  pause() {
    ...
    S(this, Ai, !0), this.track.enabled = !1, this.safeEmit("pause");
  }
  /**
  ...
  resume() {
    ...
    S(this, Ai, !1), this.track.enabled = !0, this.safeEmit("resume");
  }
}
Yo = new WeakMap(), Ai = new WeakMap(), Is = new WeakMap(), Fd = new WeakMap(), As = new WeakSet(), Cr = function() {
  return {
    consumer: {
      id: this.id,
...
var ps, la, ua, Mi, Xt, Ze, Fr, ha, qd, Lt, os;
class vD extends Ul {
  /**
  ...
  constructor(e, r) {
    ...
    m(this, ha, void 0);
    m(this, qd, void 0);
    this.id = r.id, this.localId = r.localId, S(this, Ze, r.track), this.kind = (i = r.track) == null ? void 0 : i.kind, S(this, Fr, r.disableTrackOnPause ? !((n = r.track) != null && n.enabled) : !1), S(this, ha, void 0), S(this, la, r.stopTracks), S(this, ua, r.disableTrackOnPause), S(this, Mi, r.zeroRtpOnPause), this.appData = r.appData || {}, this._onTrackEnded = this._onTrackEnded.bind(this), S(this, ps, r.handler), this.rtpSender = r.rtpSender, this._handleTrack(), S(this, qd, e);
  }
  /**
  ...
  close(e) {
    return u(this, null, function* () {
      if (a(this, Xt))
        return;
      if (this.logger.debug(`Producer::close() ${e ? `with reason ${e}` : ""}`, a(this, Lt, os)), S(this, Xt, !0), this._destroyTrack(), e === _d) {
   ...
   */
  pause() {
    this.logger.debug("Producer::pause()", a(this, Lt, os)), a(this, Xt) && this.logger.error("Producer::pause() | Producer closed", a(this, Lt, os)), S(this, Fr, !0), a(this, Ze) && a(this, ua) && (a(this, Ze).enabled = !1), a(this, Mi) && a(this, ps).replaceTrack(this.localId, null), this.emit("pause");
  }
  /**
  ...
  resume() {
    ...
    S(this, Fr, !1), a(this, Ze) && a(this, ua) && (a(this, Ze).enabled = !0), a(this, Mi) && a(this, ps).replaceTrack(this.localId, a(this, Ze)), this.emit("resume");
  }
  /**
...
ps = new WeakMap(), la = new WeakMap(), ua = new WeakMap(), Mi = new WeakMap(), Xt = new WeakMap(), Ze = new WeakMap(), Fr = new WeakMap(), ha = new WeakMap(), qd = new WeakMap(), Lt = new WeakSet(), os = function() {
  return {
    producer: {
      id: this.id,
      appData: this.appData,
  ...
  constructor(e, r, i, n) {
    ...
    p(this, "processMessage", (e) => {
      ...
      if (r[e.chunkIndex] = e, (r == null ? void 0 : r.length) === e.count && !r.some((n) => n === void 0)) {
        const n = a(this, Br).get(e.id), o = n == null ? void 0 : n.reduce((d, l) => d + l.chunk, "");
        a(this, Br).delete(e.id);
...
const _d = "transport closed";
var Oi;
const Pn = class extends Ul {
  constructor(e, {
    id: r,
    direction: i,
    handlerFactory: n,
    ...
    f.debug(`constructor() [id: ${r}, direction: ${i}]`), this.id = r, this.direction = i;
    const v = fD(l, {});
    delete v.iceServers, delete v.iceTransportPolicy, delete v.bundlePolicy, delete v.rtcpMuxPolicy, delete v.sdpSemantics, this.producers = /* @__PURE__ */ new Map(), this.consumers = /* @__PURE__ */ new Map(), this.datachannels = /* @__PURE__ */ new Map(), this.consumerTrackEvents = /* @__PURE__ */ new Map(), this.unknownTracksMap = /* @__PURE__ */ new Map(), this.awaitQueue = new Uu(f, !0), this.handler = n(), this.handler.enableHighBitrate = (C = g == null ? void 0 : g.enableHighBitrate) != null ? C : !1, this.handler.enableStereo = (_ = g == null ? void 0 : g.enableStereo) != null ? _ : !1, this.handler.enableDtx = (I = g == null ? void 0 : g.enableDtx) != null ? I : !0, this.handler.init({
    ...
    this.transportConnectionPromise = new Promise((M) => {
      ...
      (M) => {
        M !== this.connectionState && (this.logger.debug(`connection state changed to ${M}`), this.connectionState = M, M === "connected" && (this.connected = !0, this.emit("connected")), M === "disconnected" && (this.connected = !1, this.emit("disconnect")), (M === "failed" || M === "closed") && (this.connected = !1, this.emit("close")), this.closed || this.safeEmit("connectionstatechange", M));
      }
    ), this.handler.on(
      "@icecandidate",
      ({ candidate: M }) => {
      ...
      U || (U || (U = new ni(a(this, Oi), M, M.label, this.serverId), this.datachannels.set(M.label, U)), this.eventsDCFailureTimer = setTimeout(() => {
        M.label === "events" && (this.eventsDCReadyPromiseResolver(!1), this.safeEmit("dc_error", M.label));
      }, 5e3));
    }), this.handler.on("datachannel", (M, U) => {
      M.label === "events" && (this.eventsDCReadyPromiseResolver(!0), this.eventsDCFailureTimer && clearTimeout(this.eventsDCFailureTimer));
  ...
  */
  ...
  produce(e, r) {
    return u(this, null, function* () {
      ...
      const { producerId: f, localId: v, rtpSender: E } = yield this.awaitQueue.push(() => u(this, null, function* () {
        const {
          offerSdp: C,
          callback: _,
          sender: I,
  ...
  createConsumerObjectAndWaitForTrack(e) {
    return u(this, null, function* () {
      ...
      return new Promise((C, _) => u(this, null, function* () {
        const I = setTimeout(() => {
          this.logger.warn(`Timed out waiting for track event ${v} producingPeerId: ${n}`), this.consumerTrackEvents.delete(v), E.isTimedout = !0, _(E);
        }, 5e3), M = (L, B) => {
          try {
...
function ED(s) {
  ...
  if (typeof navigator == "object" && typeof navigator.userAgent == "string") {
    const t = navigator.userAgent, e = Vg.getParser(t), r = e.getEngine();
    if (e.satisfies({
      chrome: ">=74",
      chromium: ">=74",
      "microsoft edge": ">=88"
...
Xs = new WeakMap(), Ni = new WeakMap();
const _D = 2e3;
var pa, it, nt, Xo, Zo, Vi, ga, ec, ma, Li, Ms, fa, cd, tc, Bu, Gd, jf, sc, Hu, Wd, Gf, Jd, Wf, Kd, Jf, zd, Kf, Yd, zf, rc, qu, ic, ju;
class CD extends ot.EventEmitter {
  constructor(e, r) {
    super();
    m(this, fa);
    m(this, tc);
...
pa = new WeakMap(), it = new WeakMap(), nt = new WeakMap(), Xo = new WeakMap(), Zo = new WeakMap(), Vi = new WeakMap(), ga = new WeakMap(), ec = new WeakMap(), ma = new WeakMap(), Li = new WeakMap(), Ms = new WeakMap(), fa = new WeakSet(), cd = function() {
  return this.context.getValue("connectionHandler");
}, tc = new WeakSet(), Bu = function() {
  S(this, Li, {
    send: void 0,
    recv: void 0
  });
...
}, Yd = new WeakSet(), zf = function(e, r) {
  return u(this, null, function* () {
    const i = e === "recv";
    try {
  ...
  return u(this, null, function* () {
    switch (this.logger.info("Called reconnect transport", { transport: { type: e } }), this.stopTransports({ [e]: !0 }), this.context.getValue("flagsmith").hasFeature(
    ...
    ) && a(this, Vi).isConnected && a(this, ma).transportFailureCount[e] > 2 && (this.logger.warn(`Multiple disconnections in ${e} transport, forcing relay`), S(this, Ms, "relay")), yield this.setupTransports({ [e]: !0 }), e) {
      case "send": {
      ...
      case "recv": {
        this.logger.info("Transport reconnected", { transport: a(this, nt) }), this.context.getValue("peerSessionStore").emit(w.UPDATE_ACTIVE, { createAllConsumers: !0 });
        break;
      }
      default:
...
class Oh {
  ...
  create(c) {
    return u(this, arguments, function* ({
      ...
      var f, v;
      const d = Oh.getMSIDFromSDP(t.sdp, e), l = {
        description: {
          sdp: t.sdp,
          type: t.type,
          target: gr.PUBLISHER
...
var xi, Hr, Sa, nc, Ds, Xd, Zs, va, ac, Gu, Zd, Yf, el, Qf, tl, Xf, sl, Zf;
class wD extends CD {
  constructor(e, r) {
    super(e, r);
    m(this, ac);
...
xi = new WeakMap(), Hr = new WeakMap(), Sa = new WeakMap(), nc = new WeakMap(), Ds = new WeakMap(), Xd = new WeakMap(), Zs = new WeakMap(), va = new WeakMap(), ac = new WeakSet(), Gu = function() {
  return u(this, null, function* () {
...
}, Zd = new WeakSet(), Yf = function(e) {
  return a(this, nc).create(e);
}, el = new WeakSet(), Qf = function(e, r) {
...
var oc, cc, dc, Ta, ya, Ea, lc, uc, Pa, Pt, gs, ms, Ui, $i, er, hc, rl, eS, il, tS, nl, sS, al, rS;
const ol = class {
  constructor({
  ...
  processAudioChunk(t) {
    ...
    return x(this, rl, eS).call(this, e), e / a(this, gs) > a(this, Pa) && e > a(this, Pt) && r > a(this, oc) ? (S(this, Ui, a(this, Ui) + 1), S(this, $i, a(this, dc)), a(this, Ui) >= a(this, cc) && S(this, ms, !0)) : (S(this, Ui, 0), a(this, $i) > 0 ? S(this, $i, a(this, $i) - 1) : a(this, ms) && S(this, ms, !1), a(this, ms) || x(this, il, tS).call(this, e)), { energy: e, isVoice: a(this, ms) };
  }
  /**
   * Reset the detector state
   */
  reset() {
    S(this, ms, !1), S(this, Ui, 0), S(this, $i, 0), S(this, Pt, a(this, Ta)), S(this, gs, a(this, Ta) / 2), S(this, er, []);
  }
  /**
...
let oo = ol;
oc = new WeakMap(), cc = new WeakMap(), dc = new WeakMap(), Ta = new WeakMap(), ya = new WeakMap(), Ea = new WeakMap(), lc = new WeakMap(), uc = new WeakMap(), Pa = new WeakMap(), Pt = new WeakMap(), gs = new WeakMap(), ms = new WeakMap(), Ui = new WeakMap(), $i = new WeakMap(), er = new WeakMap(), hc = new WeakMap(), rl = new WeakSet(), eS = function(t) {
...
}, nl = new WeakSet(), sS = function(t) {
  return Math.sqrt(
    t.map((e) => e * e).reduce((e, r) => e + r) / t.length
  );
}, al = new WeakSet(), rS = function(t) {
  let e = 0;
...
const kD = 60, ID = 400;
var tr, sr, fs, mc, Fi, _a, rr, qr, Ca, ir, nr, Os, cl, iS, fc, Wu, dl, nS, ll, aS;
const To = class {
  constructor(t, e) {
    m(this, cl);
    m(this, dl);
    ...
    S(this, nr, r ? new ag(a(this, ir)) : new og(a(this, ir))), S(this, Os, r ? bD : Xc);
  }
  /**
   * @access private
   * Not for external use
...
let co = To;
tr = new WeakMap(), sr = new WeakMap(), fs = new WeakMap(), mc = new WeakMap(), Fi = new WeakMap(), _a = new WeakMap(), rr = new WeakMap(), qr = new WeakMap(), Ca = new WeakMap(), ir = new WeakMap(), nr = new WeakMap(), Os = new WeakMap(), cl = new WeakSet(), iS = function() {
  var o;
  ...
  return a(this, ir).getValue("flagsmith").hasFeature(te.ENABLE_AUDIO_ACTIVITY_DEBUG_LOGS) && this.logger.debug(
    `AudioActivityReporter: producer: ${a(this, fs)}, energy: ${a(this, Fi)},
				...
				maxEnergy: ${a(this, qr)}`
  ), i === -1 / 0 || e < 1e-6 ? { energy: 0, isVoice: !1 } : ((!a(this, rr) || i < a(this, rr)) && S(this, rr, i), (!a(this, qr) || i > a(this, qr)) && S(this, qr, i), { energy: (i - a(this, rr)) / (a(this, qr) - a(this, rr)) * 10 || 0, isVoice: r });
}, fc = new WeakSet(), Wu = function(t) {
  return t < 5;
}, dl = new WeakSet(), nS = function(t = a(this, Fi)) {
  var r;
  if (!a(this, fs) || !t) {
  ...
  if ("MediaStreamTrackGenerator" in window && "AudioData" in window)
    try {
      ...
      const l = () => u(void 0, null, function* () {
        try {
          const f = new Float32Array(n * o), v = new window.AudioData({
            format: "f32",
            sampleRate: i,
            numberOfFrames: n,
            numberOfChannels: o,
...
var DD = Object.defineProperty, OD = Object.getOwnPropertyDescriptor, de = (s, t, e, r) => {
  for (var i = r > 1 ? void 0 : r ? OD(t, e) : t, n = s.length - 1, o; n >= 0; n--)
    (o = s[n]) && (i = (r ? o(t, e, i) : o(i)) || i);
  return r && i && DD(t, e, i), i;
};
const kt = ["video/VP9", "video/VP8"];
var Sc, vc, at, W, Ra, mt, Bi, Hi, qi, Tc, es, ar, ji, Gi, ft, _t, jr, mn, ul, oS, hl, cS, pl, dS, yc, Ju, gl, lS, ml, uS, fl, hS, et, dt, Wi, lo, Sl, pS, vl, gS, Tl, mS;
class ae {
  constructor(t, e) {
    m(this, jr);
    /**
    ...
    m(this, gl);
    /**
     * NOTE(ikabra): joinRoom can error out in two cases:
     * 1. Socket is not connected
     * 2. Message timeout
     * We have added 15 retires just for safety, right now the backoff is exponential
     * so ideally even 6 retires should be enough to intercept if the socket disconnection.
     * but as as a failsafe incase this strategy is ever changed or the ping timeout increased,
     * we have kept the max retry count as 15.
     * Action Item: Reduce ping timeout to 10 seconds
     */
    m(this, ml);
    m(this, fl);
    m(this, et);
    ...
    this.mediaJoined = !1, S(this, ji, /* @__PURE__ */ new Map([
      ["video/VP9", /* @__PURE__ */ new Set()],
      ["video/VP8", /* @__PURE__ */ new Set()]
    ])), S(this, Gi, /* @__PURE__ */ new Map([
      ["video/VP9", /* @__PURE__ */ new Set()],
      ["video/VP8", /* @__PURE__ */ new Set()]
    ])), S(this, at, r), S(this, Bi, !1), S(this, W, new wD(t, r)), S(this, mt, a(this, W).events), S(this, ar, /* @__PURE__ */ new Set()), S(this, ft, /* @__PURE__ */ new Map()), S(this, Hi, !1), S(this, qi, new Uu(t.getValue("logger"))), S(this, _t, new co(
      this.context,
      a(this, W).socketHandler.audioActivity.bind(a(this, W).socketHandler)
    )), this.e2ee = (n = (i = t.getValue("modules").e2ee) == null ? void 0 : i.enabled) != null ? n : !1, this.handleSocketEvents(), this.handleCallstatsEvents(), S(this, Tc, vh(
      () => u(this, null, function* () {
  ...
  joinRoom(o, c) {
    return u(this, arguments, function* (t, e, r = !1, i = !1, n = {}) {
      a(this, jr, mn).mediaJoinAttempted = !0, S(this, Bi, !0), r && this.reset();
      try {
        ...
        return this.logger.error("Error in room joining process", { error: d }), this.context.getValue("peerSessionStore").emit(w.ROOM_NODE_FAILED), { roomJoined: !1, error: d };
      }
    });
  }
  /**
  ...
  leaveRoom() {
    return u(this, null, function* () {
      a(this, W).stopAllTransports(), S(this, Hi, !1), a(this, jr, mn).mediaJoinAttempted = !1;
      const t = {
        closeRoom: !1
      };
      ...
      try {
        ...
        if (e) {
          ...
          if (a(this, W).producers.has(o)) {
            ...
            yield a(this, W).closeProducer(o, { stopTrack: !1 });
          }
  ...
  resetVideoProducers(t, e) {
    return u(this, null, function* () {
      if (t) {
        ...
        yield a(this, W).closeProducer(r, { stopTrack: !1 }), yield a(this, W).closeProducer(i, { stopTrack: !1 }), this.shareWebcam(t);
      }
      if (e) {
...
Sc = new WeakMap(), vc = new WeakMap(), at = new WeakMap(), W = new WeakMap(), Ra = new WeakMap(), mt = new WeakMap(), Bi = new WeakMap(), Hi = new WeakMap(), qi = new WeakMap(), Tc = new WeakMap(), es = new WeakMap(), ar = new WeakMap(), ji = new WeakMap(), Gi = new WeakMap(), ft = new WeakMap(), _t = new WeakMap(), jr = new WeakSet(), mn = function() {
  return this.context.getValue("connectionHandler");
}, ul = new WeakSet(), oS = function(t, e, r, i) {
  return u(this, null, function* () {
    S(this, vc, t);
    try {
...
}, yc = new WeakSet(), Ju = function(t, e, r, i) {
  return u(this, null, function* () {
    try {
      const n = x(this, gl, lS).call(this);
      yield x(this, ml, uS).call(this, t, e, r, n), yield a(this, W).setupTransports({ send: !0, recv: !0 }), yield x(this, fl, hS).call(this, i);
    } catch (n) {
      throw this.logger.error("Failed to initialize connection", { error: n }), n;
    }
  });
}, gl = new WeakSet(), lS = function() {
  var r;
...
}, ml = new WeakSet(), uS = function(t, e, r, i) {
  return u(this, null, function* () {
    yield Ff(
  ...
  return u(this, null, function* () {
    if (!(!this.context.getValue("flagsmith").hasFeature(
      ...
      try {
        const r = [];
        if (t.canProduceVideo === H.Allowed && r.push(this.shareWebcam(MD(!1))), t.canProduceAudio === H.Allowed) {
          const i = AD(!1);
...
}, et = new WeakSet(), dt = function(t) {
  return a(this, ft).get(t);
}, Wi = new WeakSet(), lo = function(t, e) {
  return a(this, ft).set(t, e);
}, Sl = new WeakSet(), pS = function(t) {
  return a(this, ft).delete(t);
}, vl = new WeakSet(), gS = function(t) {
  return {
    track: t,
    encodings: [
      {
...
}, Tl = new WeakSet(), mS = function(t, e) {
  return {
    track: t,
...
var ND = Object.defineProperty, VD = Object.getOwnPropertyDescriptor, ln = (s, t, e, r) => {
...
const vS = (Ag = class {
  ...
  setupEvents() {
    a(this, Z).getValue("peerSessionStore").on(w.RESET_PRODUCER_STATE, () => u(this, null, function* () {
      ...
      if (this.self.roomState === "disconnected")
        return;
      let { peerId: t } = this;
      s && a(this, Z).getValue("flagsmith").hasFeature(te.REFRESH_ID_ON_DISCONNECTION) && (t = tn()), a(this, Ji).updateURL(t), a(this, Z).getValue("telemetry").resetPeerId(t), vt().setHeader("tracing-id", t), lr.remapContext(t, a(this, Z)), this.self.roomState = "disconnected", this.self.emit("roomLeft", { state: "disconnected" });
  ...
  leaveRoom(s = "left") {
    return u(this, null, function* () {
      ...
      this.self.setIsPinned(!1), a(this, Z).setValue("stageStatus", "OFF_STAGE", !1), yield this.leaveMediaRoom(s), a(this, Z).notify("stageStatus");
      try {
  ...
  leaveMediaRoom(s) {
    return u(this, null, function* () {
      ...
      s !== "connected-meeting" && (yield this.cleanupSelf()), !(s === "stageLeft" && t === hr.Webinar) && a(this, St, At) && (a(this, St, At).mediaJoined && s !== "disconnected" && (yield a(this, St, At).leaveRoom()), !(s === "stageLeft" && t === hr.Livestream) && (a(this, St, At).mediaJoined = !1));
    });
  }
  cleanupSelf() {
    return u(this, null, function* () {
...
}, Ji = new WeakMap(), Ss = new WeakMap(), Z = new WeakMap(), St = new WeakSet(), At = function() {
...
Pc = new WeakMap(), _c = new WeakMap();
var UD = Object.defineProperty, $D = Object.getOwnPropertyDescriptor, Nh = (s, t, e, r) => {
...
var FD = Object.defineProperty, BD = Object.getOwnPropertyDescriptor, HD = (s, t, e, r) => {
  ...
  joinRoom(t) {
    return u(this, null, function* () {
      ...
      try {
        ...
        a(this, xt).getValue("connectionHandler").socketJoined = !0, a(this, xt).getValue("peerSessionStore").emit(w.SOCKET_SERVICE_ROOM_JOINED, { peer: n });
...
class jD {
  ...
  removePlugin(t) {
    a(this, qe).sendMessage(
      J.removePlugin,
      tA.toBinary({ pluginId: t, staggered: !1 })
    );
  }
  getActivePlugins() {
    return u(this, null, function* () {
...
qe = new WeakMap(), Cc = new WeakMap();
var GD = Object.defineProperty, WD = (s, t, e) => t in s ? GD(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : s[t] = e, JD = (s, t, e) => (WD(s, typeof t != "symbol" ? t + "" : t, e), e), Vh = (s, t, e) => {
  if (!t.has(s))
    throw TypeError("Cannot " + e);
}, D = (s, t, e) => (Vh(s, t, "read from private field"), e ? e.call(s) : t.get(s)), fe = (s, t, e) => {
  if (t.has(s))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(s) : t.set(s, e);
}, ne = (s, t, e, r) => (Vh(s, t, "write to private field"), r ? r.call(s, e) : t.set(s, e), e), Pe = (s, t, e) => (Vh(s, t, "access private method"), e), Cd = {}, KD = {
  get exports() {
    return Cd;
  },
  set exports(s) {
...
}, wn = typeof Reflect == "object" ? Reflect : null, cg = wn && typeof wn.apply == "function" ? wn.apply : function(s, t, e) {
...
function _S(s, t, e) {
  var r = { fired: !1, wrapFn: void 0, target: s, type: t, listener: e }, i = YD.bind(r);
  return i.listener = e, r.wrapFn = i, i;
}
...
function ZD(s, t) {
  return new Promise(function(e, r) {
    ...
    bS(s, t, n, { once: !0 }), t !== "error" && eO(s, i, { once: !0 });
  });
}
function eO(s, t, e) {
...
var IS = /* @__PURE__ */ ((s) => (s[s.CONNECTING = 0] = "CONNECTING", s[s.OPEN = 1] = "OPEN", s[s.CLOSING = 2] = "CLOSING", s[s.CLOSED = 3] = "CLOSED", s))(IS || {});
const nO = "2", aO = "3";
var Ie, fn, Ee, Le, wr, Ye, dr, Kr, Ts, Sn, Fs, Ku, AS, uo, ld, zu, MS, Yu, ug, Rd, Qu, Xu, DS, mo, ud, fo, wd, bd, Zu, bn, So, vo, kd;
class oO {
  constructor(t, e) {
      ...
      if (D(this, dr) !== !1)
        return new Promise((e, r) => {
          ...
          try {
            ...
            const i = setTimeout(() => {
              D(this, Le).debug("Connection timeout. Closing socket"), ne(this, dr, !0), Pe(this, vo, kd).call(this), D(this, Ie).close(3001, "Connection Timeout"), D(this, Ee).autoReconnect && !D(this, Ts) && (D(this, Ye).emit(
                "reconnecting"
                /* reconnecting */
  ...
  send(t, e, r, i) {
    ...
    if (D(this, Ee).queueOnDisconnect && (!D(this, Ie) || D(this, Ie).readyState !== 1))
      return D(this, Le).debug("Queuing message since socket is not connected!", n), D(this, wr).push(n), !1;
    const o = kS.encode(n);
   ...
   */
  disconnect() {
    ne(this, dr, !1), Pe(this, bn, So).call(this), this.removeAllListeners(), ne(this, Kr, {
      code: 1e3,
...
Ie = /* @__PURE__ */ new WeakMap(), fn = /* @__PURE__ */ new WeakMap(), Ee = /* @__PURE__ */ new WeakMap(), Le = /* @__PURE__ */ new WeakMap(), wr = /* @__PURE__ */ new WeakMap(), Ye = /* @__PURE__ */ new WeakMap(), dr = /* @__PURE__ */ new WeakMap(), Kr = /* @__PURE__ */ new WeakMap(), Ts = /* @__PURE__ */ new WeakMap(), Sn = /* @__PURE__ */ new WeakMap(), Fs = /* @__PURE__ */ new WeakMap(), Ku = /* @__PURE__ */ new WeakSet(), AS = function(s) {
...
}, mo = /* @__PURE__ */ new WeakSet(), ud = function(s = !0) {
  return u(this, null, function* () {
    if (s && D(this, Ts)) {
    ...
    ne(this, Ts, !0), Pe(this, vo, kd).call(this), Pe(this, bn, So).call(this);
    try {
      if (yield D(this, Fs).wait(), D(this, dr) === !1)
        return;
      ...
      D(this, Le).debug("Failed to reconnect."), D(this, Ye).emit("reconnectFailure", { attempt: D(this, Fs).getAttempts() }), Pe(this, mo, ud).call(this, !1);
    }
  });
}, fo = /* @__PURE__ */ new WeakSet(), wd = function(s) {
  try {
    return D(this, Ie).send(s), !0;
  } catch (t) {
    return D(this, Le).error(t.message), !1;
  }
  ...
  this.config.disconnectOnPingTimeout && (D(this, Le).debug("Resetting ping timeout"), Pe(this, bn, So).call(this), ne(this, Sn, setTimeout(() => {
    var s;
    D(this, Le).debug("Disconnecting the socket due to ping timeout"), ne(this, dr, !0);
...
var cO = Object.defineProperty, dO = Object.getOwnPropertyDescriptor, Bl = (s, t, e, r) => {
  for (var i = r > 1 ? void 0 : r ? dO(t, e) : t, n = s.length - 1, o; n >= 0; n--)
    (o = s[n]) && (i = (r ? o(t, e, i) : o(i)) || i);
  return r && i && cO(t, e, i), i;
};
const hg = 65535, lO = 3e3;
var Gr, Ce, Re, Me, ts, ze, Rc, eh, wc, th, Mg;
const OS = (Mg = class {
  constructor(s, {
    peerId: t,
    meetingId: e,
  ...
  connect() {
    return u(this, null, function* () {
      a(this, Re, Me).socketJoinAttempted = !0, yield a(this, Ce).connect(), a(this, Re, Me).socketJoinAttempted = !0, a(this, Re, Me).socketState = {
        state: "connected",
        reconnected: !1,
        reconnectionAttempt: void 0
      };
  ...
  disconnect() {
    a(this, Re, Me).socketJoinAttempted = !1, a(this, Ce).disconnect(), a(this, Re, Me).socketJoinAttempted = !0, a(this, Re, Me).socketState = {
      state: "disconnected",
      reconnected: !1,
      reconnectionAttempt: void 0
    };
    ...
    return new Promise(
      (o, c) => {
        ...
        const f = ({
          ...
          l === E && (o({ id: E, payload: C }), d(v, f));
        };
        a(this, Ce).on(n, v), a(this, Ce).on(hg, f), a(this, Ce).on(br.errorResponse, f), a(this, Ce).on(ys.errorResponse, f), setTimeout(() => {
...
}, Gr = new WeakMap(), Ce = new WeakMap(), Re = new WeakSet(), Me = function() {
  return a(this, ze).getValue("connectionHandler");
}, ts = new WeakMap(), ze = new WeakMap(), Rc = new WeakSet(), eh = function(s) {
...
var hO = Object.defineProperty, pO = Object.getOwnPropertyDescriptor, gO = (s, t, e, r) => {
...
var mO = Object.defineProperty, fO = Object.getOwnPropertyDescriptor, Lh = (s, t, e, r) => {
...
var SO = Object.defineProperty, vO = Object.getOwnPropertyDescriptor, ql = (s, t, e, r) => {
...
const vn = class {
  ...
  static init(s) {
    return u(this, null, function* () {
      ...
      const _ = Du.init(f.preset, !s.getValue("modules").theme);
      s.setValue("theme", _);
      const I = Lu.init(
        s,
        _.viewType,
        f.preset.permissions
  ...
  static setupControllers(s, t, e, r, i, n, o) {
    return u(this, null, function* () {
      ...
      t.setValue("viewType", g), t.setValue("defaults", O({
        mediaConfiguration: {
          audio: {
            enableHighBitrate: (V = f.enableHighBitrate) != null ? V : !1,
            enableStereo: (b = f.enableStereo) != null ? b : !1
          }
        }
...
class EO {
  constructor() {
    ...
    m(this, bc, void 0);
    a(this, Wr).srcObject = a(this, Ki), a(this, Wr).autoplay = !0;
  }
  playTracks(t) {
    return u(this, null, function* () {
      return t.forEach((e) => {
...
Wr = new WeakMap(), Ki = new WeakMap(), zi = new WeakMap(), bc = new WeakMap(), yl = new WeakSet(), LS = function(t) {
  var e;
...
Yi = new WeakMap();
var _O = Object.defineProperty, CO = Object.getOwnPropertyDescriptor, jl = (s, t, e, r) => {
...
let Qr = (Og = class {
  ...
  static initMedia() {
    return u(this, arguments, function* (t = {}, e = !1, r = void 0) {
      var d;
      const i = (d = r == null ? void 0 : r.peerId) != null ? d : tn(), n = lr.createContext(i, {
        peerId: i
      }), o = n.getValue("logger");
      o.init(n);
      const c = new $f(n, o);
  ...
  static init(t) {
    return u(this, null, function* () {
      var f, v, C, _, I, M, U;
      _e.init();
      const e = (v = (f = t == null ? void 0 : t.cachedUserDetails) == null ? void 0 : f.peerId) != null ? v : tn(), { authToken: r, baseURI: i } = t, E = yO(r, i), { meetingId: n } = E, o = Bc(E, ["meetingId"]);
      ...
      GS(l), pg.init(l), d.init(c, {
        ...
        peerId: e
      }, (I = (_ = t.modules) == null ? void 0 : _.tracing) != null ? I : !0), l.init(c), l.info("Client::init::options", {
...
}, je = new WeakMap(), Qi = new WeakMap(), Og);
jl([
  ct("0002"),
  Tr.executeWithLock({
