...
export class RtkPinnedMessageSelector {
    ...
    static get is() { return "rtk-pinned-message-selector"; }
    static get encapsulation() { return "shadow"; }
    static get originalStyleUrls() {
        return {
            "$": ["rtk-pinned-message-selector.css"]
        };
    }
    ...
    static get events() {
        return [{
                ...
                "docs": {
                    "tags": [],
                    "text": "Emits when a pinned message is selected"
                },
                "complexType": {
                    "original": "Message",
    ...
    static get listeners() {
        return [{
                "name": "rtkChatSelectorChange",
                "method": "onChatSelectorChange",
                "target": "window",
                "capture": false,
                "passive": false
            }];
