...
:host {
  ...
  border-width: var(--rtk-border-width-sm, 1px);
  border-style: solid;
  --tw-border-opacity: 1;
  border-color: rgba(var(--rtk-colors-background-700, 44 44 44) / var(--tw-border-opacity));
}
...
:host([view='sidebar']) {
  ...
  --tw-shadow-color: rgb(var(--rtk-colors-background-900, 26 26 26));
