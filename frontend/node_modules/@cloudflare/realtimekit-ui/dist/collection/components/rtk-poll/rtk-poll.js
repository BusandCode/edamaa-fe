        ...
        return {
            ...
            "permissions": {
                ...
                "complexType": {
                    ...
                    "resolved": "{ readonly mediaRoomType: string; readonly stageEnabled: Readonly<boolean>; readonly acceptStageRequests: Readonly<boolean>; readonly stageAccess: MediaProductionPermissionType; readonly acceptWaitingRequests: Readonly<boolean>; readonly requestProduceVideo: Readonly<boolean>; readonly requestProduceAudio: Readonly<boolean>; readonly requestProduceScreenshare: Readonly<boolean>; readonly canAllowParticipantAudio: Readonly<boolean>; readonly canAllowParticipantScreensharing: Readonly<boolean>; readonly canAllowParticipantVideo: Readonly<boolean>; readonly canDisableParticipantAudio: Readonly<boolean>; readonly canDisableParticipantVideo: Readonly<boolean>; readonly kickParticipant: Readonly<boolean>; readonly pinParticipant: Readonly<boolean>; readonly canRecord: Readonly<boolean>; readonly waitingRoomType: WaitingRoomTypes; readonly waitingRoomBehaviour: WaitingRoomTypes; readonly plugins: Readonly<{ canClose: boolean; canStart: boolean; canEditConfig?: boolean; config: { [pluginId: string]: Partial<{ accessControl: any; disabled: boolean; handlesViewOnly: boolean; }>; }; }>; readonly polls: Readonly<{ canCreate: boolean; canVote: boolean; canView: boolean; }>; readonly produceVideo: MediaProductionPermissionType; readonly requestProduce: Readonly<boolean>; readonly canProduceVideo: MediaProductionPermissionType; readonly produceScreenshare: MediaProductionPermissionType; readonly canProduceScreenshare: MediaProductionPermissionType; readonly produceAudio: MediaProductionPermissionType; readonly canProduceAudio: MediaProductionPermissionType; readonly chatPublic: Readonly<{ canSend: boolean; text: boolean; files: boolean; }>; readonly chatPrivate: Readonly<{ canSend: boolean; canReceive: boolean; text: boolean; files: boolean; }>; readonly connectedMeetings: Readonly<{ canAlterConnectedMeetings: boolean; canSwitchConnectedMeetings: boolean; canSwitchToParentMeeting: boolean; }>; readonly hiddenParticipant: Readonly<boolean>; readonly showParticipantList: Readonly<boolean>; readonly canChangeParticipantRole: Readonly<boolean>; readonly canChangeParticipantPermissions: Readonly<boolean>; readonly canChangeTheme: Readonly<boolean>; readonly canPresent: Readonly<boolean>; readonly acceptPresentRequests: Readonly<boolean>; readonly canEditDisplayName: Readonly<boolean>; readonly maxScreenShareCount: number; readonly isRecorder: Readonly<boolean>; readonly canSpotlight: Readonly<boolean>; readonly canLivestream: Readonly<boolean>; readonly transcriptionEnabled: Readonly<boolean>; readonly logger: Logger; readonly emit: <E extends keyof PermissionEvents>(event: E, ...args: Parameters<PermissionEvents[E]>) => boolean; readonly on: <E extends keyof PermissionEvents>(event: E, callback: PermissionEvents[E]) => PermissionPreset; readonly addListener: <E extends keyof PermissionEvents>(event: E, callback: PermissionEvents[E]) => PermissionPreset; readonly off: <T extends keyof PermissionEvents>(event: T, callback: PermissionEvents[T]) => PermissionPreset; readonly once: <T extends keyof PermissionEvents>(event: T, callback: PermissionEvents[T]) => PermissionPreset; readonly prependListener: <T extends keyof PermissionEvents>(event: T, callback: PermissionEvents[T]) => PermissionPreset; readonly prependOnceListener: <T extends keyof PermissionEvents>(event: T, callback: PermissionEvents[T]) => PermissionPreset; readonly removeListener: <T extends keyof PermissionEvents>(event: T, callback: PermissionEvents[T]) => PermissionPreset; readonly removeAllListeners: <T extends keyof PermissionEvents>(event?: T) => PermissionPreset; readonly listeners: <T extends keyof PermissionEvents>(event: T) => Function[]; readonly listenerCount: <T extends keyof PermissionEvents>(event: T) => number; readonly [EventEmitter.captureRejectionSymbol]?: <K>(error: Error, event: string | symbol, ...args: AnyRest) => void; readonly setMaxListeners: (n: number) => PermissionPreset; readonly getMaxListeners: () => number; readonly rawListeners: <K>(eventName: string | symbol) => Function[]; readonly eventNames: () => (string | symbol)[]; }",
                    "references": {
                        "RTKPermissionsPreset": {
                            "location": "import",
                            "path": "@cloudflare/realtimekit",
                            "id": "../../node_modules/@cloudflare/realtimekit/dist/index.d.ts::RTKPermissionsPreset"
                        }
                    }
                },
                "required": false,
