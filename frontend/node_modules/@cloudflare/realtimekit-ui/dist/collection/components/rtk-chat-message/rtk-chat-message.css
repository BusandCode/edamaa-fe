...
.show-on-hover rtk-menu {
      visibility: hidden;
}

.show-on-hover:hover rtk-menu {
      visibility: visible;
}
.align-right .message {
...
.align-right .message .head {
      ...
      flex-direction: row-reverse;
      gap: var(--rtk-space-4, 16px);
}
.align-right .message rtk-text-message .bubble,  .align-right .message rtk-image-message .bubble,  .align-right .message rtk-file-message .bubble {
...
.align-right .message .actions rtk-icon {
      color: rgb(var(--rtk-colors-text-on-brand-1000, var(--rtk-colors-text-1000, 255 255 255)));
}
.align-right rtk-menu {
      left: auto;
...
.body.bubble {
      ...
      padding-left: var(--rtk-space-5, 20px);
      padding-right: var(--rtk-space-5, 20px);
      overflow-wrap: break-word;
      font-size: 14px;
      line-height: 1.375;
...
.image .image-spinner rtk-spinner {
      --tw-text-opacity: 1;
...
.new-chat-marker::before {
  ...
  height: 1px;
  flex: 1 1 0%;
  background-color: rgba(var(--rtk-colors-brand-300, 73 124 253) / 0.5);
}
...
.show-new-messages {
      pointer-events: auto;
      --tw-translate-y: calc(var(--rtk-space-6, 24px) * -1);
...
blockquote {
      ...
      border-bottom-width: var(--rtk-border-width-none, 0);
      border-left-width: var(--rtk-border-width-md, 2px);
      border-right-width: var(--rtk-border-width-none, 0);
      border-style: solid;
      border-left-color: rgb(var(--rtk-colors-text-900, 255 255 255 / 0.88));
      padding: var(--rtk-space-0\.5, 2px);
      padding-left: var(--rtk-space-2, 8px);
      margin-bottom: var(--rtk-space-2, 8px) !important;
      border-radius: var(--rtk-border-radius-sm, 4px);
      border-top-left-radius: var(--rtk-border-radius-none, 0);
      border-bottom-left-radius: var(--rtk-border-radius-none, 0);
}
.link {
      color: rgb(var(--rtk-colors-text-900, 255 255 255 / 0.88));
}
...
.align-right .block-quote {
      border-color: rgb(var(--rtk-colors-text-on-brand-600, var(--rtk-colors-text-600, 255 255 255 / 0.52)));
      --tw-bg-opacity: 1;
      background-color: rgba(var(--rtk-colors-brand-300, 73 124 253) / var(--tw-bg-opacity));
}
...
.align-right .image .actions rtk-icon {
      --tw-text-opacity: 1;
      color: rgba(var(--rtk-colors-brand-300, 73 124 253) / var(--tw-text-opacity));
}
...
.left-align .body {
      --tw-translate-x: calc(var(--rtk-space-8, 32px) * -1);
      transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));
}
