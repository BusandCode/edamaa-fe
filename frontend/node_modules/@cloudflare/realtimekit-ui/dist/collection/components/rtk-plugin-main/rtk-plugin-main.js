    ...
    static get properties() {
        return {
            ...
            "plugin": {
                ...
                "complexType": {
                    "original": "RTKPlugin",
                    "resolved": "{ readonly baseURL: string; readonly createdAt: Date; readonly description: string; readonly id: string; readonly name: string; readonly organizationId: string; readonly picture: string; readonly private: boolean; readonly published: boolean; readonly staggered: boolean; readonly tags: string[]; readonly type: string; readonly updatedAt: Date; readonly config?: PluginConfig; readonly active: boolean; readonly iframes: Map<string, { iframe: HTMLIFrameElement | ReactNativeWebView; listener?: (message: MessageEvent<any>) => void; }>; readonly enabledBy: string; readonly telemetry: Telemetry; readonly sendIframeEvent: (message: PluginIframeMessage) => void; readonly sendData: (payload: SendDataOptions) => void; readonly removePluginView: (viewId?: string) => void; readonly addPluginView: (iframe: HTMLIFrameElement | ReactNativeWebView, viewId?: string) => void; readonly activateForSelf: () => Promise<void>; readonly deactivateForSelf: () => void; readonly enable: () => Promise<void>; readonly disable: () => void; readonly activate: () => Promise<void>; readonly deactivate: () => Promise<void>; readonly logger: Logger; readonly emit: (event: PluginEvents$1, ...args: any[]) => boolean; readonly on: (event: PluginEvents$1, callback: (...args: any[]) => void) => Plugin; readonly addListener: (event: PluginEvents$1, callback: (...args: any[]) => any) => Plugin; readonly off: (event: PluginEvents$1, callback: (...args: any[]) => any) => Plugin; readonly once: (event: PluginEvents$1, callback: (...args: any[]) => any) => Plugin; readonly prependListener: (event: PluginEvents$1, callback: (...args: any[]) => any) => Plugin; readonly prependOnceListener: (event: PluginEvents$1, callback: (...args: any[]) => any) => Plugin; readonly removeListener: (event: PluginEvents$1, callback: (...args: any[]) => any) => Plugin; readonly removeAllListeners: (event?: PluginEvents$1) => Plugin; readonly listeners: (event: PluginEvents$1) => Function[]; readonly listenerCount: (event: PluginEvents$1) => number; readonly [EventEmitter.captureRejectionSymbol]?: <K>(error: Error, event: string | symbol, ...args: AnyRest) => void; readonly setMaxListeners: (n: number) => Plugin; readonly getMaxListeners: () => number; readonly rawListeners: <K>(eventName: string | symbol) => Function[]; readonly eventNames: () => (string | symbol)[]; }",
                    "references": {
                        "RTKPlugin": {
                            "location": "import",
                            "path": "@cloudflare/realtimekit",
                            "id": "../../node_modules/@cloudflare/realtimekit/dist/index.d.ts::RTKPlugin"
                        }
                    }
                },
                "required": true,
