...
:host {
  ...
  --rtk-controlbar-button-background-color: rgb(var(--rtk-colors-background-700, 44 44 44));
}
...
.uneditable-name .text, 
  .uneditable-name .name {
...
input:focus {
  --tw-border-opacity: 1;
  border-color: rgba(var(--rtk-colors-brand-500, 33 96 253) / var(--tw-border-opacity));
}

rtk-spinner {
  color: rgb(var(--rtk-colors-text-1000, 255 255 255));
  --icon-size: var(--rtk-space-8, 32px);
}
