...
export class RtkChatMessagesUiPaginated {
    ...
    static get properties() {
        return {
            ...
            "privateChatRecipient": {
                ...
                "complexType": {
                    ...
                    "references": {
                        "Participant": {
                            "location": "import",
                            "path": "../../types/rtk-client",
                            "id": "src/types/rtk-client.ts::RTKParticipant"
                        }
                    }
                },
                "required": false,
                ...
                "docs": {
                    "tags": [],
                    "text": "Selected recipient for private chat; when unset, messages are loaded for public chat (Everyone)."
                },
                "getter": false,
                "setter": false
            }
    ...
    static get watchers() {
        return [{
                "propName": "privateChatRecipient",
                "methodName": "privateChatRecipientChanged"
            }, {
                "propName": "meeting",
    ...
    static get listeners() {
        return [{
                "name": "rtkPinnedMessageSelect",
                "method": "onPinnedMessageSelect",
                "target": "window",
                "capture": false,
                "passive": false
            }];
