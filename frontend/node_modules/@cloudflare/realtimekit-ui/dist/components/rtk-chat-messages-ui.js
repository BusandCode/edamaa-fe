...
const RtkChatMessagesUi$1 = /*@__PURE__*/ proxyCustomElement(class RtkChatMessagesUi extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
__decorate([
    SyncWithStore()
], RtkChatMessagesUi$1.prototype, "iconPack", void 0);
__decorate([
    SyncWithStore()
], RtkChatMessagesUi$1.prototype, "t", void 0);
    ...
    components.forEach(tagName => { switch (tagName) {
        case "rtk-chat-messages-ui":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, RtkChatMessagesUi$1);
            }
            break;
        case "rtk-avatar":
            if (!customElements.get(tagName)) {
...
export { RtkChatMessagesUi, defineCustomElement };
