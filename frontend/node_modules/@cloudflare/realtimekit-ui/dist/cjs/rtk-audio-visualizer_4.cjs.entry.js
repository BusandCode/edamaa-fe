...
const RtkSwitch = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: 'af0bcf0202cda77f3ec27510b867ed149c478bdf', role: "switch", tabIndex: this.disabled && 0, "aria-readonly": this.readonly, "aria-checked": this.checked, "aria-disabled": this.disabled, class: { checked: this.checked }, onClick: this.onClick, onKeyPress: this.onKeyPress }, index$1.h("div", { key: 'e6f5eeb8acf33e9f058b029423eddc099033053c', class: "switch", part: "switch" })));
    }
    static get watchers() { return {
