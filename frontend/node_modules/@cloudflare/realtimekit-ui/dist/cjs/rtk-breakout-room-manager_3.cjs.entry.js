...
const RtkBreakoutRoomParticipants = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: '7b4fb8a52a766c434d0190690adee236653f8695' }, index$1.h("div", { key: '6b9beba4ad3838402b502d6b3122d37bfc5b30a4', class: "search-wrapper" }, index$1.h("div", { key: '932ecc0612acb51bd938ca9794af9b47c7bc09b8', class: "search", part: "search" }, index$1.h("rtk-icon", { key: '6b375cbd17ce7deb3b38081cfb692ec443983a35', icon: this.iconPack.search, part: "search-icon", class: "search-icon" }), index$1.h("input", { key: '0b39fa195d5e915e74a1968a3f7344d0eb684b41', type: "search", autocomplete: "off", placeholder: this.t('search'), onInput: this.onSearchInput, part: "search-input" })), index$1.h("slot", { key: '71aa49c87ae265fb8a3a698081dc97d9491eb77b', name: "shuffle-button" })), index$1.h("div", { key: '01be3dbfb519320ad40f135eb02e79cc7b0e418a', class: "header" }, index$1.h("div", { key: 'd52d19db24477cb31119ea67e8c3873bde405cf6', class: "title-wrapper" }, index$1.h("span", { key: 'ebb123556faf18cbb29d8e80c4720922c25f29c4' }, this.t('breakout_rooms.main_room')), index$1.h("span", { key: '3764c3184de86a8b47084ec43092f931ef80921a', class: "participant-count" }, "(", index$1.h("rtk-icon", { key: '4b442b5e54b446861af22d63d21bf153d44307a0', icon: this.iconPack.people }), this.participantsToShow.length, ")")), this.selectedParticipantIds.length !== 0 && (index$1.h("rtk-tooltip", { key: '84dd5dea2a502ce55f860ab46bc160d5f1fac3a5', label: this.t('breakout_rooms.select_all') }, index$1.h("input", { key: 'ba4de556aa6417f62e11b345d6c5deddeaada678', type: "checkbox", checked: this.selectedParticipantIds.length === this.participantsToShow.length, onChange: (e) => this.onToggleAll(!!e.target.checked) })))), index$1.h("div", { key: 'a5460550231bb96b13bcd72ab97c15bc0ca9227d', class: "ctr scrollbar", part: "container" }, this.participantsToShow.length > 0 && (index$1.h("ul", { key: 'dbe3c4fc0bed63ff086b02f431ff0e880c7c008f', class: "participants", part: "participants" }, this.participantsToShow.map((participant) => (index$1.h("li", { class: { 'participant-item': true, dragging: this.isDragging }, onClick: () => this.onClick(participant), onDragStart: () => this.onDragStart(participant), onDragEnd: () => this.onDragEnd(participant), draggable: this.selectedParticipantIds.length === 0, role: "listitem", key: participant.id }, this.renderPeer(participant), !this.isDragging && (index$1.h("input", { type: "checkbox", class: {
                'hide-checkbox': this.selectedParticipantIds.length === 0,
            }, checked: this.selectedParticipantIds.includes(uiStore.participantIdentifier(participant)) }))))))), this.participantsToShow.length === 0 && this.search.length > 0 && (index$1.h("div", { key: '96c88d33922b97ca5fc5752a85862e11eaa214cb', class: "empty-message" }, this.t('participants.errors.empty_results'))), this.participantsToShow.length === 0 && this.search.length === 0 && (index$1.h("div", { key: '74a766dfc41fafe84a5e34d0352cbec27d0b8b1e', class: "empty-room" }, index$1.h("rtk-icon", { key: '32f1e3389b316f4c9471960a7bdfedc2817d86a9', icon: this.iconPack.people_checked, part: "search-icon", class: "search-icon" }), index$1.h("p", { key: '0de2996cedffac1734a277e226978768b875aabd' }, this.t('breakout_rooms.all_assigned')), index$1.h("span", { key: '83c7195b681e00ab53a52ecaad490c9b7501d5b0' }, this.t('breakout_rooms.empty_main_room')))))));
    }
...
const RtkCounter = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: '1a38f004dde59c6b3308da362468889c272f74ad' }, index$1.h("rtk-button", { key: '80e9418f53ef38b9519030c7c189393f0e5f3828', kind: "icon", variant: "ghost", onClick: () => this.decrement() }, index$1.h("rtk-icon", { key: 'a4bb69f891d33e5d8a3d408acce90d643e5a7ff4', icon: this.iconPack.subtract })), index$1.h("input", { key: 'd929003c3e35ca2286bc8ae30468b21d41de6169', type: "number", value: this.input, min: this.minValue, onInput: (e) => {
            ...
            } }), index$1.h("rtk-button", { key: 'c177aecca19effd3d4d9dfed8e7a8de97ae29a92', kind: "icon", variant: "ghost", onClick: () => this.increment() }, index$1.h("rtk-icon", { key: '67bb245cd43706f8073c4009cbf1dbec9716afc6', icon: this.iconPack.add }))));
    }
    static get watchers() { return {
