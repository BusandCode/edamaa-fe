...
const uiStore = require('./ui-store-9d5b8dc5.js');
...
const index = require('./index-2c1fa663.js');
const debounce = require('./debounce-41bbfad3.js');
...
const RtkParticipant = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { key: '32d79a75f1b073c080e90112cc013652ed238050' }, index$1.h("div", { class: "left", key: (_e = this.participant) === null || _e === void 0 ? void 0 : _e.id }, index$1.h("rtk-avatar", { key: '5ec0ee4daf93e870289b66f08cc63797919b83d5', participant: this.participant, size: "sm", iconPack: this.iconPack, t: this.t }), index$1.h("p", { key: '6008d8fef3b5ad18f451e4ee0e6321b3915e1758', class: "name", title: name }, string.shorten(name, 16), " ", ((_f = this.meeting) === null || _f === void 0 ? void 0 : _f.self.id) === ((_g = this.participant) === null || _g === void 0 ? void 0 : _g.id) && this.t('(you)'))), this.view === 'sidebar' && (index$1.h("div", { key: '2c2cd09021fc5eaca8bbdc856a070d17b852ba55', class: "right" }, isActiveParticipant && (index$1.h("rtk-icon", { key: '82f359bff954f8cf3c5a1e4f1525c18888d8c461', class: {
                red: !this.audioEnabled,
            }, icon: this.audioEnabled ? this.iconPack.mic_on : this.iconPack.mic_off })), isActiveParticipant && !isAudioRoom && (index$1.h("rtk-icon", { key: '0e380137610333d6d749e48f81455b60e5245e47', class: {
            ...
            }) > 0) && (index$1.h("div", { key: '9281c88dd452ac704719bdb5775947c15dc1141c', class: "menu" }, index$1.h("span", { key: '122b9b706be2ee3d28d92b60445e6f6e23284520', id: "trigger", onClick: this.onMenuToggle }, index$1.h("rtk-button", { key: '0147bfba303cd57e1319d72e12ba0a5677c4a954', variant: "ghost", kind: "icon", slot: "trigger" }, index$1.h("rtk-icon", { key: '4793d1ec49a1457a39539e0cfe16973a8dd48ffd', class: "more", icon: this.iconPack.more_vertical }))), index$1.h("span", { key: '0b5028074336a787014f06ae930d17069330a0a2', id: "menu-list" }, this.menuOpen && (index$1.h("rtk-menu-list", { key: 'e40c57aba210b0cddd18bd1433866f8f3ab9a6ed', iconPack: this.iconPack, t: this.t }, this.canPinParticipant && isActiveParticipant && !isAudioRoom && (index$1.h("rtk-menu-item", { key: '45df96331cf834237d9b4c6eaccfa2e4d68c2e17', onClick: () => {
                if (this.isPinned) {
            ...
            }, iconPack: this.iconPack, t: this.t }, index$1.h("rtk-icon", { key: 'ed81b8b4a7635182ea4de64921f4ddce625bca69', icon: this.isPinned ? this.iconPack.pin_off : this.iconPack.pin, slot: "start" }), this.isPinned ? this.t('unpin') : this.t('pin'))), isSelf && (index$1.h("rtk-menu-item", { key: '8b55ae7b82e2670c1bc43f1b291be440fa647f5b', iconPack: this.iconPack, t: this.t, onClick: () => {
                this.isHidden
                    ? this.participant.show()
                    : this.participant.hide();
            } }, index$1.h("rtk-icon", { key: '74c2ea2ee3dddb24aefa6f99f1df0b7e1b38bbbc', icon: this.isHidden ? this.iconPack.minimize : this.iconPack.maximize, slot: "start" }), !this.meeting.self.hidden ? this.t('minimize') : this.t('maximize'))), this.canDisableParticipantAudio &&
            isActiveParticipant &&
            this.audioEnabled && (index$1.h("rtk-menu-item", { key: '16a995b8ba5da1b5a89ed462ec6ad8d939bb1ead', iconPack: this.iconPack, t: this.t, onClick: () => {
                this.participant.disableAudio();
            } }, index$1.h("rtk-icon", { key: '851e66e51a0cf768e2c84815b7dccb5bdad7f4c3', icon: this.iconPack.mic_off, slot: "start" }), this.t('mute'))), this.canDisableParticipantVideo &&
            isActiveParticipant &&
            this.videoEnabled && (index$1.h("rtk-menu-item", { key: 'b3c9f6d8310cea37eb8d0ea52e7ce76ed65d30bd', iconPack: this.iconPack, t: this.t, onClick: () => {
                this.participant.disableVideo();
            } }, index$1.h("rtk-icon", { key: '10c6a6ba789c2eb84c9654800d32c0bac835a326', icon: this.iconPack.video_off, slot: "start" }), this.t('participants.turn_off_video'))), this.canAllowParticipantOnStage &&
            ((_h = this.participant) === null || _h === void 0 ? void 0 : _h.id) !== ((_j = this.meeting) === null || _j === void 0 ? void 0 : _j.self.id) && (index$1.h("rtk-menu-item", { key: '2a2f9c4c1d65f0306e14e11b533b844def79f9ec', iconPack: this.iconPack, t: this.t, class: this.isOnStage ? 'red' : '', onClick: this.inviteToStageToggle }, index$1.h("rtk-icon", { key: 'f166167aeda7b3054a5978bcf829b9e2acba748e', icon: this.isOnStage
                ? this.iconPack.leave_stage
                : this.iconPack.join_stage, slot: "start" }), this.isOnStage
            ? this.t('stage.remove_from_stage')
            : this.t('stage.add_to_stage'))), !isSelf && this.canKickParticipant && (index$1.h("rtk-menu-item", { key: '511973ee2a231f947f579892c49665c1a5ab20f3', iconPack: this.iconPack, t: this.t, class: "red", onClick: () => {
                var _a, _b;
                (_a = this.meeting) === null || _a === void 0 ? void 0 : _a.participants.kick((_b = this.participant) === null || _b === void 0 ? void 0 : _b.id);
            } }, index$1.h("rtk-icon", { key: '38a7d90dd761fe6b5c573992ea6e59a8797696fc', icon: this.iconPack.dismiss, slot: "start" }), this.t('kick'))), index$1.h("slot", { key: 'ecdf440bc30129695e2a2f6a8026f3ef3cab083b' }, index$1.h(index$2.Render, { key: 'd2c67848ff22c07bc3a9c8b5957e67c5208d7cff', element: "rtk-participant", defaults: defaults, childProps: {
                participant: this.participant,
