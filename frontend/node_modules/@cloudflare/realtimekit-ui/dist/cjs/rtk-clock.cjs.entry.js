...
const RtkClock = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { key: '38836be8a2179a1cd5a01217bb9bcb39c5200b60', "data-hidden": !showClock, tabIndex: 0, role: "timer", "aria-live": "off" }, this.startedTime !== undefined && [
            index$1.h("rtk-icon", { key: '510051b64ae8676988164df6eb0e04567ede57c8', icon: this.iconPack.clock, "aria-hidden": true, tabIndex: -1, part: "icon" }),
            index$1.h("span", { key: '5990d231ad6ceb66ff7ae1ddc17ca6857c6c4628', part: "text" }, this.getFormattedTime()),
        ]));
    }
