...
const chat = require('./chat-02670cc5.js');
...
const RtkChatComposerUi = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { key: 'c1bbf529244184de2062ddb50b40a918fe6b89f0' }, this.canSendTextMessage && this.emojiPickerActive && (index$1.h("rtk-emoji-picker", { key: '62c92f177bdf7ff725a345efd948fbd07e58efda', part: "emoji-picker", onPickerClose: () => {
                this.emojiPickerActive = false;
            }, onRtkEmojiClicked: (e) => {
                this.$textArea.value += e.detail;
                this.$textArea.focus();
            }, t: this.t })), this.renderSuggestedReplies(), index$1.h("slot", { key: '02f70148bdae1f9e3b9fc60d088c59f85af68880', name: "chat-addon" }), index$1.h("slot", { key: '0ac47b719d6c39807076f86bcd0fe4fb9b75fcd5', name: "quote-block" }), index$1.h("div", { key: 'e88db8097f1615f62235c41262700c0c11bc0453', class: "chat-input", part: "chat-input" }, this.renderMenu(), this.canSendTextMessage && (index$1.h("textarea", { key: 'f1aa0c834b37e25a7e3093d10b6ad4531d58c0e8', class: "scrollbar", part: "textarea", ref: this.initializeTextField, autoFocus: true, placeholder: this.fileToUpload ? '' : this.t('chat.message_placeholder'), value: defaultValue, onPaste: this.onPaste, maxLength: chat.MAX_TEXT_LENGTH, onKeyDown: this.handleKeyDown, onKeyUp: this.handleKeyUp, onInput: (e) => {
                uiStore.gracefulStorage.setItem(this.storageKey, e.target.value);
            }, disabled: !!this.filePreview })), index$1.h("div", { key: '724a8e40a0384c4f11efca4d7abf081b110a7c9f', class: "chat-buttons", part: "chat-buttons" }, index$1.h("div", { key: '028b74f93d7b8ba1964460ea80ed4c63d56e5146', class: "left", part: "chat-buttons-left" }, !this.prefill.editMessage &&
            this.canSendFiles && [
            index$1.h("rtk-tooltip", { key: 'e4b0edc4f6a0f8f8b91ec4925dbd661c3e3b1a32', label: this.t('chat.send_file') }, index$1.h("rtk-button", { key: '53f030c9720362995342eb1959da07136c44724b', variant: "ghost", kind: "icon", onClick: () => this.uploadFile('file'), title: this.t('chat.send_file') }, index$1.h("rtk-icon", { key: '51bf45a1074886452e1c7d6ca80d8b5f9e7a61ba', icon: this.iconPack.attach }))),
            index$1.h("rtk-tooltip", { key: 'd20a53b034f312ced9d7f5441da7574100cbb6e7', label: this.t('chat.send_img') }, index$1.h("rtk-button", { key: '822413ff8636a33d2d70c7d10412a0ff5d043d86', variant: "ghost", kind: "icon", onClick: () => this.uploadFile('image'), title: this.t('chat.send_img') }, index$1.h("rtk-icon", { key: 'af60e5ec42253e7780af31bc5f2fb9ad00ad6245', icon: this.iconPack.image }))),
        ], !this.prefill.editMessage && this.canSendTextMessage && !this.disableEmojiPicker && (index$1.h("rtk-tooltip", { key: '665bb180737c220297a9394f582ddd8d57135ed4', label: this.t('chat.send_emoji') }, index$1.h("rtk-button", { key: '6550bd345555644e89a501df5838452206ea9c55', variant: "ghost", kind: "icon", class: { active: this.emojiPickerActive }, title: this.t('chat.send_emoji'), onClick: () => {
                this.emojiPickerActive = !this.emojiPickerActive;
            } }, index$1.h("rtk-icon", { key: '4ee0c02bf3efc309a58db7be0f51545d6d346a9c', icon: this.iconPack.emoji_multiple }))))), !!this.filePreview && this.renderFilePreview(), this.canSendTextMessage && (index$1.h("div", { key: 'a7d3f27cbe43f591363d1ffd8858f30d457e6629', class: "right", part: "chat-buttons-right" }, !this.prefill.editMessage && (index$1.h("rtk-tooltip", { key: '57fc69e04c29b54cfb8510914659f0b94c3944eb', variant: "primary", label: this.t('chat.send_msg'), delay: 2000 }, index$1.h("rtk-button", { key: '949e480cc2a243265f1268aff6396cd9bda20b03', kind: "icon", onClick: () => this.handleSendMessage(), title: this.t('chat.send_msg') }, index$1.h("rtk-icon", { key: '8fe5bc5391bef475805c86ab3fec94690bd71dfd', icon: this.iconPack.send })))), this.prefill.editMessage && (index$1.h("div", { key: '3e87dae17dcac9be10a20fe15252756d496bf924', class: "edit-buttons" }, index$1.h("rtk-tooltip", { key: '201e7b44dc8a40cfc94bb299448a1e89c972ea92', variant: "secondary", label: this.t('cancel'), delay: 2000 }, index$1.h("rtk-button", { key: '64d5dc9e41bc87a654c760c709b7b7d378f28141', kind: "icon", variant: "secondary", onClick: () => this.handleEditCancel(), title: this.t('cancel') }, index$1.h("rtk-icon", { key: '7e75e511da878e45f88b75c2f23a855a8c191b9b', icon: this.iconPack.dismiss }))), index$1.h("rtk-tooltip", { key: 'df6284b88ac9651d5cb1c736b92fb929ee5795a1', variant: "primary", label: this.t('chat.update_msg'), delay: 2000 }, index$1.h("rtk-button", { key: 'c6b375320d193ccbf6658aa040302453ae361f91', kind: "icon", onClick: () => this.handleEditMessage(), title: this.t('chat.send_msg') }, index$1.h("rtk-icon", { key: 'f047153809bc154526364f2e9a903449f83f51a9', icon: this.iconPack.checkmark })))))))))));
    }
};
__decorate([
    index.SyncWithStore()
