...
const RtkTabBar = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: '1c4bce26c4c5baa19cd89be862922267c408ab97' }, index$1.h("rtk-spotlight-indicator", { key: '496f3634771c4b9c94ff64e23fa5695e2e1532e2', meeting: this.meeting, iconPack: this.iconPack, t: this.t, size: this.size }), this.tabs.map((tab) => {
            var _a, _b, _c, _d, _e;
            let isActive = false;
