...
const RtkAudioGrid = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { key: '4597696c9b9794c5e97cf260d691b237f371e3ec' }, index$1.h("div", { key: 'b228fd72f7c54f76466072c396391d58c774bc0b', class: "content scrollbar" }, index$1.h("div", { key: 'd1264d9d9328569d834feccff8ab70013c70dfc3', class: "stage grid" }, this.renderGrid(onStage)), this.offStageParticipants.length > 0 && (index$1.h("div", { key: '3c8e8c5e5b8b750505444113f4d756160fa0ea40', class: "waitlist-area" }, index$1.h("div", { key: '5dddb7068b87b291b45bfdd29205e04310036518', class: "listening-title" }, this.offStageParticipants.length, " ", this.t('grid.listening')), index$1.h("div", { key: '674f8b7c767b3baac6c761e453dfd47c0cb14fa8', class: "waitlist-grid grid" }, this.renderGrid(this.offStageParticipants))))), index$1.h("slot", { key: 'e3fccf54ebdeeb288a4b7fad3dd8f1a0cbd0460f' })));
    }
