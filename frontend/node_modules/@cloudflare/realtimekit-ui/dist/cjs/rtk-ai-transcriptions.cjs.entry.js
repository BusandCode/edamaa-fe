...
const RtkAiTranscriptions = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: 'd188f9eda11cb4e09a6efdc95662bdb851b5d8e0' }, index$1.h("div", { key: 'ae8d5801e85be7426f153932f7931350bcd2432b', class: "search-bar" }, index$1.h("input", { key: '3bf534c010ed777ba879d3ae022ea3c99c915825', type: "text", placeholder: "Search participant", value: this.participantQuery, onInput: (e) => (this.participantQuery = e.target.value) })), this.isProcessing && (index$1.h("div", { key: 'bf494c1c17144597a565c634e57c3449a6e80b07', class: "processing" }, index$1.h("p", { key: 'c5b95f670810a34b3f216fd6342b5fee8c4f472b' }, "Processing audio...."))), !this.isProcessing && (index$1.h("div", { key: '18cd43d6de0bcdc71a7531363e1bd5321bf9c495', class: "content scrollbar", ref: (el) => (this.contentContainer = el) }, index$1.h("div", { key: '53e0c59bff87a669ce02656dbabef6dcef65200c', class: "started-message" }, "Transcription started"), this.renderTranscripts()))));
    }
