...
const RtkControlbarButton = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: '90cbc7f04dd7975ef7331aace992aeadd1fdba52' }, index$1.h("button", { key: '36ea971cf7d69742346dd6a65b41ef57def59a40', "aria-label": this.label, part: "button" }, this.isLoading ? (index$1.h("rtk-spinner", { id: "icon", part: "spinner", iconPack: this.iconPack })) : (index$1.h("rtk-icon", { id: "icon", icon: this.icon, tabIndex: -1, "aria-hidden": true, part: "icon" })), index$1.h("span", { key: '83dda2888c01eec119c1cc21921a682cc2111307', class: "label", part: "label" }, this.label), this.showWarning && (index$1.h("rtk-icon", { key: 'abddcd4d3c81f7ba09cc4595c98cb55c76d678ad', id: "warning-indicator", icon: this.iconPack.warning, part: "warning-indicator" })))));
    }
