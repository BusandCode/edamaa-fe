...
const RtkChatMessagesUi = class {
    ...
    connectedCallback() {
        var _a;
        if (index$1.Build.isDev && !hasShownDeprecationWarning) {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { key: 'eb407b1c88839fd9892658dd53ea838b45b649ae' }, index$1.h("div", { key: 'b3aa97bb11d4ce2fa688bb6171947505e3520b71', class: "chat-container scrollbar", ref: (el) => (this.$chat = el), part: "container" }, index$1.h("div", { key: '8652876ea9af0bb1261718b412e34035cdbd905f', class: "spacer", part: "spacer" }), index$1.h("div", { key: 'dd5caf3b54ff4378d75c3d2d4faec5dfaa79abb7', class: "chat", part: "chat" }, (_a = this.messages) === null || _a === void 0 ? void 0 : _a.map((item) => {
            if (item.type === 'chat') {
                const { message } = item;
            ...
            return null;
        }))), index$1.h("div", { key: 'd6d8dd49909ce709059c37a36a2a2bbb00ddadce', class: "show-new-messages-ctr" }, index$1.h("rtk-button", { key: '4ce0073d4c5ea5116d555557e8bdbac52a68b34a', class: {
                'show-new-messages': true,
                active: this.showLatestMessageButton,
            }, kind: "icon", part: "show-new-messages", onClick: this.scrollToBottom }, index$1.h("rtk-icon", { key: '8e62ffccf8ac65eafead0442eaa4fb4447d5083a', icon: this.iconPack.chevron_down })))));
    }
