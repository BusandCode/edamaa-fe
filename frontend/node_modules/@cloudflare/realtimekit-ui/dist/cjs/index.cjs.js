...
const merge = require('./merge-1363c0f7.js');
const config = require('./config-e1847e71.js');
const notification = require('./notification-184b71e9.js');
...
function registerAddons(addons, meeting, config$1) {
    ...
    addons.map((addon) => {
        config$1 = addon.register(config$1, meeting, (c) => new RtkUiBuilder(c));
    });
    return config$1;
}
...
exports.defaultOverrides = uiStore.defaultOverrides;
