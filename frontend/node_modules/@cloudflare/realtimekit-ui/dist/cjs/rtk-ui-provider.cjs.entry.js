...
const RtkUiProvider = class {
    ...
    meetingChanged(meeting) {
        if (meeting) {
            this.peerStore = uiStore.createPeerStore({
                ...
                overrides: merge.deepMerge(Object.assign({}, uiStore.defaultOverrides), this.overrides),
            });
    ...
    overridesChanged(overrides) {
        if (this.peerStore) {
            this.peerStore.state.overrides = merge.deepMerge(Object.assign({}, uiStore.defaultOverrides), overrides);
        }
    }
    render() {
