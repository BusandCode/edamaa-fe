...
const RtkConfirmationModal = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { key: '2eed83d0225e57671c7039bc014556865e8df128' }, index$1.h("div", { key: '0c110b2e644334e91e3e904e79f0b6792954ef82', class: "leave-modal" }, index$1.h("div", { key: '02186a0ea5072a7144bbc80a61d60c8dd9eb0fbb', class: "header" }, index$1.h("h2", { key: 'bfaa8ae13149b4decc820663850bdbcadd3a4edf', class: "title" }, state.header ? this.t(state.header) : this.t('cta.confirmation'))), state.content && index$1.h("p", { key: '59763c35fc925fefa3a7f30fe8918f4ff9c6dc25', class: "message" }, this.t(state.content)), index$1.h("div", { key: 'c6245c328e93a663b89d5ae61accc6484453cca5', class: "content" }, index$1.h("div", { key: '5f48291e64473e56380e624cdfd571d56075f0b8', class: "leave-meeting" }, index$1.h("rtk-button", { key: '4dd43baac193b83996c305e02443e5e047cd6bc5', variant: "secondary", title: state.cancelText ? this.t(state.cancelText) : this.t('cancel'), onClick: this.close, class: "br-secondary-btn" }, state.cancelText ? this.t(state.cancelText) : this.t('cancel')), index$1.h("rtk-button", { key: '4741c90b5191f53373657fdf184e1a1dbe15af47', onClick: () => this.onConfirmation(), variant: (_b = (_a = this.states.activeConfirmationModal) === null || _a === void 0 ? void 0 : _a.variant) !== null && _b !== void 0 ? _b : 'danger', title: state.ctaText ? this.t(state.ctaText) : this.t('yes') }, state.ctaText ? this.t(state.ctaText) : this.t('yes')))))));
    }
};
__decorate$6([
    index.SyncWithStore()
...
const RtkJoinStage = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { key: '2000c74c7b15b8ad8cc8d7b2940ee1c47c504111', class: { stage: true } }, index$1.h("header", { key: '1be2b7c17338f42472bd47c761e8a972d960eb45' }, index$1.h("h2", { key: '8a2d2e49eb154fc58f121f26c067519473007aa1' }, this.dataConfig.title)), index$1.h(index$2.Render, { key: '17476c475c67d3eedfce7e66a2dc1829211e6f7b', element: "rtk-participant-setup", defaults: defaults, props: { participant: (_a = this.meeting) === null || _a === void 0 ? void 0 : _a.self, size: 'md' }, childProps: { participant: (_b = this.meeting) === null || _b === void 0 ? void 0 : _b.self, size: 'md' }, deepProps: true }), index$1.h("div", { key: '708a514d2f5c903c5e01161a374455134f9c5fde', class: "summary" }, this.dataConfig.description), index$1.h("div", { key: '690c062b55469b6d2757628cf9c841db05cb50dd', class: "container" }, index$1.h("rtk-button", { key: '3c840601730f7c31da94f58fcc7a36fa7f2e98ac', variant: "secondary", onClick: () => this.leaveStage.emit(), title: this.dataConfig.label.reject }, this.dataConfig.label.reject), index$1.h("rtk-button", { key: 'd4838af3f9b36c6d91ce04d9862840ee838111de', onClick: () => {
                if (this.isLoading)
                    return;
                this.isLoading = true;
                this.joinStage.emit();
